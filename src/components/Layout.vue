  ...
  <div class="layout">
    <div class="titlebar" style="-webkit-app-region: drag">
      <div class="titlebar-controls" style="-webkit-app-region: no-drag">
        ...
        <button style="-webkit-app-region: no-drag" class="titlebar-btn" @click="maximize" title="最大化">
        ...
        <button style="-webkit-app-region: no-drag" class="titlebar-btn close" @click="close" title="关闭">
