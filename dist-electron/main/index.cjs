...
</html>`}var qt=null,W=null;function Jt(e){if(!(!L||L.isDestroyed()))try{L.webContents.send(`ball-snap`,e)}catch{}}function Yt(e){if(e<=0)return 0;if(e>=1)return 1;let t=2*Math.PI/3;return 2**(-10*e)*Math.sin((e*10-.75)*t)+1}function Xt(e){return e===`left`||e===`right`?{w:44,h:58}:{w:58,h:44}}function Zt(e,t,n,r){if(!Number.isFinite(e)||!Number.isFinite(t)||!Number.isFinite(n.x)||!Number.isFinite(n.y)){k.warn(`Floating ball snap skipped (non-finite input):`,{x:e,y:t,to:n});return}let{w:i,h:a}=Xt(r);W&&=(clearInterval(W),null);let o=Date.now();W=setInterval(()=>{if(!L||L.isDestroyed()){W&&=(clearInterval(W),null);return}let s=Math.min(1,(Date.now()-o)/420),c=Yt(s);H({x:Math.round(e+(n.x-e)*c),y:Math.round(t+(n.y-t)*c),width:Math.round(B+(i-B)*c),height:Math.round(B+(a-B)*c)}),s>=1&&(W&&=(clearInterval(W),null),H({x:n.x,y:n.y,width:i,height:a}),qt=r,Jt(r),R={x:n.x,y:n.y},xt(R),k.info(`Floating ball snapped (elastic teardrop) to edge:`,[n.x,n.y],r,`${i}x${a}`))},16)}function Qt(){W&&=(clearInterval(W),null),qt&&(qt=null,Jt(null))}function $t(){d.ipcMain.handle(`show-floating-ball`,()=>{zt()}),d.ipcMain.handle(`hide-floating-ball`,()=>{Bt()}),d.ipcMain.handle(`toggle-floating-ball`,()=>{Bt()}),d.ipcMain.on(`floating-ball-expand`,()=>{Ut()}),d.ipcMain.on(`floating-ball-collapse`,()=>{Wt()}),d.ipcMain.on(`floating-ball-action`,(e,t)=>{k.info(`Floating ball action:`,t),Gt(t)});let e=null;d.ipcMain.on(`floating-ball-drag-start`,(t,n,r)=>{if(!L||L.isDestroyed())return;Qt();let[i,a]=L.getPosition(),[o,s]=L.getSize();if(o!==B||s!==B){let t=Math.round(i+o/2),c=Math.round(a+s/2);H({x:t-B/2,y:c-B/2,width:B,height:B});let[l,u]=L.getPosition();z={winX:l,winY:u,scrX:n,scrY:r},e={w:B,h:B}}else z={winX:i,winY:a,scrX:n,scrY:r},e={w:o,h:s}}),d.ipcMain.on(`floating-ball-move`,(t,n,r)=>{if(!L||L.isDestroyed()||!z||!e||!Number.isFinite(n)||!Number.isFinite(r))return;let i=n-z.scrX,a=r-z.scrY,o=Math.round(z.winX+i),s=Math.round(z.winY+a);H({x:o,y:s,width:e.w,height:e.h});let[c,l]=L.getPosition();(c!==o||l!==s)&&H({x:o+(o-c),y:s+(s-l),width:e.w,height:e.h})}),d.ipcMain.on(`floating-ball-drag-end`,()=>{if(z=null,e=null,L&&!L.isDestroyed()){let[e,t]=L.getPosition(),[n,r]=L.getSize(),i=d.screen.getDisplayMatching(L.getBounds()).bounds,a=U().snapGutter,o=Math.abs(e-(i.x+a)),s=Math.abs(i.x+i.width-a-(e+n)),c=Math.abs(t-(i.y+a)),l=Math.abs(i.y+i.height-a-(t+r)),u=null,f=Number.MAX_VALUE;o<40&&o<f&&(f=o,u=`left`),s<40&&s<f&&(f=s,u=`right`),c<40&&c<f&&(f=c,u=`top`),l<40&&l<f&&(f=l,u=`bottom`),u===`left`?Zt(e,t,{x:i.x+a,y:t},`left`):u===`right`?Zt(e,t,{x:i.x+i.width-a-n,y:t},`right`):u===`top`?Zt(e,t,{x:e,y:i.y+a},`top`):u===`bottom`&&Zt(e,t,{x:e,y:i.y+i.height-a-r},`bottom`)}R&&xt(R)}),d.ipcMain.handle(`get-floating-ball-settings`,()=>U()),d.ipcMain.handle(`set-floating-ball-settings`,(e,t)=>{let n={...U()},r=jt(t);if(Rt(r),t.openAtLogin!==void 0)try{d.app.setLoginItemSettings({openAtLogin:t.openAtLogin})}catch(e){k.error(`setLoginItemSettings failed:`,e)}if(t.menuItems&&JSON.stringify(n.menuItems)!==JSON.stringify(r.menuItems)&&Nt(),t.locale!==void 0&&n.locale!==r.locale){Nt(),gt();let e=d.BrowserWindow.getAllWindows();for(let t of e)if(!t.isDestroyed())try{t.webContents.send(`app-locale-changed`,{locale:r.locale})}catch{}k.info(`Floating ball locale changed: ${n.locale} -> ${r.locale}`)}return r}),d.ipcMain.handle(`reset-floating-ball-position`,()=>{if(Pt(),Qt(),L&&!L.isDestroyed()){let e=d.screen.getPrimaryDisplay().bounds,t=Math.round(e.x+(e.width-B)/2),n=Math.round(e.y+(e.height-B)/2);Vt=!1;try{L.webContents.executeJavaScript(`document.body.classList.remove('expanded'); var s=document.getElementById('ringSvg');if(s){while(s.firstChild){s.removeChild(s.firstChild)}} menuCreated=false; isExpanded=false; void 0;`).catch(()=>{})}catch{}H({x:t,y:n,width:B,height:B}),R={x:t,y:n};let[r,i]=L.getPosition();(r!==t||i!==n)&&H({x:t+(t-r),y:n+(n-i),width:B,height:B})}})}var en=s(((e,t)=>{A();var n=null;function r(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e).resize({width:16,height:16})}function i(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.png`):(0,u.join)(__dirname,`../../public/logo.png`);return e?d.nativeImage.createFromPath(e).resize({width:64,height:64,quality:`better`}):d.nativeImage.createEmpty()}function a(){if(n&&!n.isDestroyed())return;n=new d.Tray(r()),n.setToolTip(`二支录制`);let e=d.Menu.buildFromTemplate([{label:`显示设置窗口`,click:()=>{process.emit(`clawd-show-settings-window`)}},{type:`separator`},{label:`退出`,click:()=>{let{app:e}=require(`electron`);e.quit()}}]);n.setContextMenu(e),n.on(`click`,()=>{process.emit(`clawd-show-settings-window`)}),k.info(`System tray created`)}function o(e,t){n&&!n.isDestroyed()&&(n.displayBalloon({title:e,content:t,icon:i()}),k.info(`Tray balloon:`,e,t))}function s(){n&&!n.isDestroyed()&&(n.destroy(),n=null)}t.exports={createTray:a,showBalloon:o,destroyTray:s}}))();A();var tn={available:!1,playing:!1,title:``,artist:``,album:``,hasSession:null},nn=`
...
`,rn={play:`TryPlayAsync`,pause:`TryPauseAsync`,next:`TrySkipNextAsync`,prev:`TrySkipPreviousAsync`},an=e=>`
Add-Type -AssemblyName System.Runtime.WindowsRuntime
$asTaskGeneric=([System.WindowsRuntimeSystemExtensions].GetMethods()|Where-Object{$_.Name -eq 'AsTask' -and $_.GetParameters().Count -eq 1 -and $_.GetParameters()[0].ParameterType.Name -eq 'IAsyncOperation\`1'})[0]
function Await($t,$rt){$asTask=$asTaskGeneric.MakeGenericMethod($rt);$n=$asTask.Invoke($null,@($t));$n.Wait(-1)|Out-Null;$n.Result}
try{
...
`;function on(e){return new Promise(t=>{(0,p.execFile)(`powershell.exe`,[`-NoProfile`,`-NonInteractive`,`-NoLogo`,`-Command`,e],{windowsHide:!0,timeout:8e3,maxBuffer:4*1024*1024},(e,n)=>{if(e){t(``);return}t(n.trim())})})}async function sn(){try{let e=(await on(nn)).match(/\{.*\}/s);if(!e)return tn;let t=JSON.parse(e[0]);return t.available?{available:!0,playing:!!t.playing,title:t.title||``,artist:t.artist||``,album:t.album||``,hasSession:t.hasSession}:tn}catch(e){return k.warn(`[music-smtc] read failed:`,e?.message??e),tn}}async function cn(e){let t=rn[e];if(!t)return!1;try{let e=await on(an(t));return/"ok":true/.test(e)}catch{return!1}}A();var G=null;function ln(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`..`,`..`,`public`,`logo.ico`);return d.nativeImage.createFromPath(e)}function un(){if(G&&!G.isDestroyed()){G.show(),G.focus();return}let e=process.env.VITE_DEV_SERVER_URL,t=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);G=new d.BrowserWindow({icon:ln(),width:400,height:480,minWidth:340,minHeight:380,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`音乐`,backgroundColor:`#eaeaec`,webPreferences:{preload:t,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),e?G.loadURL(`${e}#/music?t=${Date.now()}`):G.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/music`}),G.once(`ready-to-show`,()=>{G?.show()}),G.on(`closed`,()=>{G=null}),k.info(`Music window shown`)}function dn(){G&&!G.isDestroyed()&&G.destroy(),G=null}function fn(){d.ipcMain.handle(`show-music-window`,()=>un()),d.ipcMain.handle(`close-music-window`,()=>dn()),d.ipcMain.handle(`music-get-status`,()=>sn()),d.ipcMain.handle(`music-control`,(e,t)=>cn(t))}var pn={info:()=>{},warn:()=>{},error:()=>{}},mn=null,hn=`todo-notes.json`,gn=`todo-settings.json`;function _n(){if(mn)return mn;let{app:e}=require(`electron`);return e.getPath(`userData`)}function vn(){return(0,u.join)(_n(),hn)}function yn(){return(0,u.join)(_n(),gn)}function bn(){try{let e=_.readFileSync(vn(),`utf-8`),t=JSON.parse(e);if(Array.isArray(t.items))return{items:t.items.filter(e=>e&&typeof e.id==`string`),meta:{schemaVersion:t.meta?.schemaVersion??1}}}catch{}return{items:[],meta:{schemaVersion:1}}}function K(){return bn().items}function xn(e){let t=vn(),n=t+`.tmp`;try{_.writeFileSync(n,JSON.stringify(e,null,2),`utf-8`),_.renameSync(n,t)}catch{try{_.writeFileSync(t,JSON.stringify(e,null,2),`utf-8`)}catch(e){pn.error(`todo store save failed:`,e?.message??e)}}}function Sn(e){xn({items:e,meta:{schemaVersion:1}})}function Cn(e){let t=K(),n=Date.now(),r={id:(0,x.randomUUID)(),type:e.type,title:e.title??``,content:e.content??``,priority:e.priority??`medium`,reminder:e.reminder??null,reminderFired:!1,done:e.done??!1,pinned:!1,pinX:null,pinY:null,createdAt:n,updatedAt:n};return t.unshift(r),Sn(t),t}function wn(e,t){let n=K(),r=n.find(t=>t.id===e);return r?(Object.assign(r,t,{updatedAt:Date.now()}),Sn(n),n):n}function Tn(e,t){let n=K(),r=n.find(t=>t.id===e);return r?(t.reminder!==void 0&&t.reminder!==r.reminder&&(r.reminderFired=!1),Object.assign(r,t,{updatedAt:Date.now()}),Sn(n),n):n}function En(e){let t=K().filter(t=>t.id!==e);return Sn(t),t}function Dn(e){let t=K(),n=t.find(t=>t.id===e);return n&&n.type===`todo`&&(n.done=!n.done,n.updatedAt=Date.now(),Sn(t)),t}function On(e){return wn(e,{reminderFired:!0})}function kn(e,t){let n=K(),r=n.find(t=>t.id===e);return r?(r.pinned=!r.pinned,r.pinned&&t&&(r.pinX=Math.round(t.x),r.pinY=Math.round(t.y)),r.updatedAt=Date.now(),Sn(n),n):n}function An(e){return e.filter(e=>e.type===`todo`&&!e.done).length}var jn={badgeVisible:!0,windowAlwaysOnTop:!0,stickyBoardPos:null};function Mn(){try{let e=JSON.parse(_.readFileSync(yn(),`utf-8`));return{badgeVisible:typeof e.badgeVisible==`boolean`?e.badgeVisible:jn.badgeVisible,windowAlwaysOnTop:typeof e.windowAlwaysOnTop==`boolean`?e.windowAlwaysOnTop:jn.windowAlwaysOnTop,stickyBoardPos:e.stickyBoardPos&&typeof e.stickyBoardPos.x==`number`&&typeof e.stickyBoardPos.y==`number`?{x:e.stickyBoardPos.x,y:e.stickyBoardPos.y}:null}}catch{return{...jn}}}function Nn(e){let t={...Mn(),...e};try{_.writeFileSync(yn(),JSON.stringify(t,null,2),`utf-8`)}catch(e){pn.error(`todo settings save failed:`,e?.message??e)}return t}var Pn=!1;function q(){let e=An(K()),t=Mn().badgeVisible;Lt(e,Pn,t)}function Fn(e){Pn=e,q()}function In(){Fn(!1)}function Ln(){d.ipcMain.on(`floating-ball-badge-ready`,()=>{q()})}A(),P();var J=null;function Rn(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`..`,`..`,`public`,`logo.ico`);return d.nativeImage.createFromPath(e)}function zn(){if(J&&!J.isDestroyed()){J.show(),J.focus(),In();return}let e=process.env.VITE_DEV_SERVER_URL,t=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);J=new d.BrowserWindow({icon:Rn(),width:525,height:450,minWidth:320,minHeight:360,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:N(`todo.stickyTitle`),backgroundColor:`#eaeaec`,webPreferences:{preload:t,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),J.setAlwaysOnTop(Mn().windowAlwaysOnTop,`normal`),e?J.loadURL(`${e}#/todo?t=${Date.now()}`):J.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/todo`}),J.once(`ready-to-show`,()=>{J?.show()}),J.on(`closed`,()=>{J=null}),In(),k.info(`Todo window shown`)}function Bn(){J&&!J.isDestroyed()&&J.close(),J=null}function Vn(){return!!(J&&!J.isDestroyed())}function Hn(){let e=!Mn().windowAlwaysOnTop;return Nn({windowAlwaysOnTop:e}),J&&!J.isDestroyed()&&J.setAlwaysOnTop(e,`normal`),e}function Un(e){if(zn(),!J||J.isDestroyed())return;let t=()=>{J&&!J.isDestroyed()&&J.webContents.send(`todo-focus-item`,e)};J.webContents.isLoading()?J.webContents.once(`did-finish-load`,t):t()}function Wn(e){if(!J||J.isDestroyed())return;let t=()=>{J&&!J.isDestroyed()&&J.webContents.send(`todo-data-changed`,e)};J.webContents.isLoading()?J.webContents.once(`did-finish-load`,t):t()}A(),P();var Y=null;function Gn(e,t){let n=$e(32);return`<!DOCTYPE html><html><head><meta charset="utf-8"><style>
*{margin:0;padding:0;box-sizing:border-box;user-select:none}
...
.open:hover{background:#404db9}
  ...
  <div class="body">
    <div class="t">${Kn(e)||N(`todo.reminTitle`)}</div>
    <div class="b">${Kn(t)||N(`todo.reminderBody`)}</div>
