...
</body></html>`;l.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(ee)}`),j.info(`Region border+toolbar shown (split windows):`,e),y=e,t?.cameraEnabled&&te(e,t.cameraDeviceId),l&&!l.isDestroyed()&&l.setAlwaysOnTop(!0,`screen-saver`),f&&!f.isDestroyed()&&f.setAlwaysOnTop(!0,`screen-saver`),h&&!h.isDestroyed()&&h.setAlwaysOnTop(!0,`screen-saver`)}function ce(e,t){f&&!f.isDestroyed()&&(f.webContents.send(`toolbar-state`,e,t,m),(e===`recording`||e===`paused`)&&m===`inside`&&p&&f.setBounds({x:p.x+8,y:p.y+8,width:170,height:40}))}function le(){l&&!l.isDestroyed()&&(l.close(),l=null)}function ue(){le(),f&&!f.isDestroyed()&&(f.close(),f=null),w(),y=null,j.info(`Region border hidden`)}function de(){d.ipcMain.on(`region-selected`,(e,t)=>{j.info(`Region selected:`,t),c(t)}),d.ipcMain.on(`region-cancelled`,()=>{j.info(`Region selection cancelled`),c(null)}),d.ipcMain.handle(`show-region-border`,(e,t,n)=>{se(t,n)}),d.ipcMain.handle(`hide-region-border`,()=>{ue()}),d.ipcMain.handle(`hide-border-only`,()=>{le()}),d.ipcMain.handle(`update-toolbar-state`,(e,t,n)=>{ce(t,n)}),d.ipcMain.on(`toolbar-action`,(e,t)=>{if(j.info(`Toolbar action:`,t),t===`close`){n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,`close`),ue();return}n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,t)}),d.ipcMain.removeHandler(`set-mouse-ignore`),d.ipcMain.removeAllListeners(`set-mouse-ignore`),d.ipcMain.handle(`show-floating-island`,(e,t,n)=>{ie(t,n)}),d.ipcMain.handle(`hide-floating-island`,()=>{ae()}),d.ipcMain.handle(`hide-camera-preview`,()=>{w()}),d.ipcMain.handle(`toggle-camera-preview`,(e,t,n)=>{t&&y?te(y,n):w()}),d.ipcMain.on(`camera-drag-start`,()=>C()),d.ipcMain.on(`camera-drag-end`,()=>ee()),d.ipcMain.handle(`set-island-state`,(e,t,n)=>{O(t,n)}),d.ipcMain.on(`island-action`,(e,t)=>{j.info(`Island action:`,t),n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,t)}),d.ipcMain.on(`resize-island`,(e,t,n)=>{if(T&&!T.isDestroyed()){if(!Number.isFinite(t))return;let e=re||d.screen.getPrimaryDisplay().bounds,r=t+20,i=Math.round(e.x+(e.width-r)/2),a=Number.isFinite(n)?n:44;T.setBounds({x:i,y:e.y+4,width:r,height:a})}})}t.exports={selectRegion:s,showRegionBorder:se,hideRegionBorder:ue,hideBorderOnly:le,updateToolbarState:ce,updateAudioLevels:i,showFloatingIsland:ie,hideFloatingIsland:ae,showCameraPreview:te,hideCameraPreview:w,setFloatingIslandState:O,setMainWindow:r,registerRegionSelectorHandlers:de}})),Ve=Be(),He=new Map;function Ue(e=32){let t=He.get(e);if(t)return t;try{let t=[(0,u.join)(__dirname,`..`,`..`,`public`,`logo.png`),(0,u.join)(__dirname,`..`,`public`,`logo.png`),(0,u.join)(__dirname,`..`,`..`,`resources`,`logo.png`)];for(let n of t)if(g.default.existsSync(n)){let t=d.nativeImage.createFromPath(n).resize({width:e,height:e,quality:`good`}).toDataURL();return He.set(e,t),t}}catch{}return``}M();var F=null,I=null,L=null,R=66,z=240,We=`floating-ball-pos.json`;function Ge(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),We)}function Ke(){try{let e=g.default.readFileSync(Ge(),`utf-8`),t=JSON.parse(e);if(typeof t.x==`number`&&typeof t.y==`number`)return t}catch{}return null}function qe(e){try{g.default.writeFileSync(Ge(),JSON.stringify(e),`utf-8`)}catch{}}function B(e){if(!(!F||F.isDestroyed())){if(!Number.isFinite(e.x)||!Number.isFinite(e.y)||!Number.isFinite(e.width)||!Number.isFinite(e.height)){j.warn(`Floating ball setBounds skipped (non-finite):`,e);return}F.setBounds(e)}}var Je=`floating-ball-settings.json`,Ye={visible:!0,alwaysOnTop:!0,openAtLogin:!1},Xe=null;function Ze(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),Je)}function Qe(){try{let e=g.default.readFileSync(Ze(),`utf-8`),t=JSON.parse(e);return{visible:typeof t.visible==`boolean`?t.visible:Ye.visible,alwaysOnTop:typeof t.alwaysOnTop==`boolean`?t.alwaysOnTop:Ye.alwaysOnTop,openAtLogin:typeof t.openAtLogin==`boolean`?t.openAtLogin:Ye.openAtLogin}}catch{}return{...Ye}}function $e(e){try{g.default.writeFileSync(Ze(),JSON.stringify(e),`utf-8`)}catch{}}function et(){return Xe||(Xe=Qe(),Xe)}function tt(e){let t={...et(),...e};return $e(t),Xe=t,t}function nt(){I=null;try{g.default.unlinkSync(Ge())}catch{}}function rt(){et().visible&&st()}function it(e){F&&!F.isDestroyed()&&F.setAlwaysOnTop(e,`screen-saver`)}function at(e,t,n){!F||F.isDestroyed()||F.webContents.executeJavaScript(`if(window.updateBadge) updateBadge(${Number(e)||0}, ${!!t}, ${!!n})`).catch(()=>{})}function ot(e){e.visible?st():ct(),it(e.alwaysOnTop)}function st(){if(F&&!F.isDestroyed()){F.show(),F.focus();return}if(!I){let e=Ke();if(e)I=e;else{let e=d.screen.getPrimaryDisplay().bounds;I={x:Math.round(e.x+(e.width-R)/2),y:Math.round(e.y+(e.height-R)/2)}}}F=new d.BrowserWindow({x:I.x,y:I.y,width:R,height:R,frame:!1,transparent:!0,backgroundColor:`#00000000`,resizable:!1,alwaysOnTop:et().alwaysOnTop,skipTaskbar:!0,hasShadow:!1,show:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),F.setVisibleOnAllWorkspaces(!0),F.setAlwaysOnTop(et().alwaysOnTop,`screen-saver`);let e=mt();F.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(e)}`),F.once(`ready-to-show`,()=>{F?.show(),F&&!F.isDestroyed()&&F.webContents.executeJavaScript(`ensureMenu()`).catch(()=>{})});let t=F;F.on(`closed`,()=>{F===t&&(F=null)}),F.on(`move`,()=>{if(!F||F.isDestroyed())return;let[e,t]=F.getPosition(),[n,r]=F.getSize();I={x:Math.round(e+n/2-R/2),y:Math.round(t+r/2-R/2)}}),F.on(`close`,()=>{I&&qe(I)}),F.on(`blur`,()=>{lt&&ft()}),j.info(`Floating ball shown`)}function ct(){if(F&&!F.isDestroyed()){let[e,t]=F.getPosition(),[n,r]=F.getSize();I={x:Math.round(e+n/2-R/2),y:Math.round(t+r/2-R/2)},qe(I);let i=F;F=null,i.destroy(),j.info(`Floating ball hidden`)}}var lt=!1,ut=null;async function dt(){if(!F||F.isDestroyed())return;ut&&=(clearTimeout(ut),null);let[e,t]=F.getPosition(),n=I?I.x:e,r=I?I.y:t,i=Math.round(n+R/2),a=Math.round(r+R/2);j.info(`[Ball] expand at`,[e,t],`center`,[i,a]);let[o]=F.getSize(),s=o!==z;s&&(F.setOpacity(0),B({x:i-z/2,y:a-z/2,width:z,height:z}));try{await F.webContents.executeJavaScript(`restartBloom(); void 0;`)}catch{}if(!(!F||F.isDestroyed())){if(s){try{await F.capturePage()}catch{}if(!F||F.isDestroyed())return;F.setOpacity(1)}lt=!0,F.webContents.send(`ball-state`,`expanded`)}}async function ft(){if(lt=!1,!F||F.isDestroyed())return;if(!I){let[e,t]=F.getPosition();I={x:Math.round(e+z/2-R/2),y:Math.round(t+z/2-R/2)}}let e=I.x,t=I.y;j.info(`[Ball] collapse at`,[e,t]);try{await F.webContents.executeJavaScript(`document.body.classList.remove('expanded'); isExpanded=false; void 0;`)}catch{}!F||F.isDestroyed()||(ut&&clearTimeout(ut),ut=setTimeout(()=>{if(ut=null,!(!F||F.isDestroyed())&&!lt){try{F.webContents.executeJavaScript(`var s=document.getElementById('ringSvg');while(s.firstChild){s.removeChild(s.firstChild)} menuCreated=false; void 0;`)}catch{}!F||F.isDestroyed()||(F.setOpacity(0),B({x:e,y:t,width:R,height:R}),F.setOpacity(1))}},920))}function pt(e){if(e===`record`)process.emit(`clawd-show-record-window`);else if(e===`ai`)process.emit(`clawd-show-ai-window`);else if(e===`todo`)process.emit(`clawd-show-todo-window`);else if(e===`settings`)process.emit(`clawd-show-settings-window`);else{let t=d.BrowserWindow.getAllWindows().find(e=>!e.isDestroyed()&&e!==F);t&&!t.isDestroyed()&&t.webContents.send(`on-floating-ball-action`,e)}ft()}function mt(){return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<style>
...
<div id="ball">
  ...
  <div class="core">
    <button id="trigger">
      <img id="logoImg" class="logo-img" src="${Ue(48)}" alt="logo" />
    </button>
...
</html>`}function ht(){d.ipcMain.handle(`show-floating-ball`,()=>{st()}),d.ipcMain.handle(`hide-floating-ball`,()=>{ct()}),d.ipcMain.handle(`toggle-floating-ball`,()=>{ct()}),d.ipcMain.on(`floating-ball-expand`,()=>{dt()}),d.ipcMain.on(`floating-ball-collapse`,()=>{ft()}),d.ipcMain.on(`floating-ball-action`,(e,t)=>{j.info(`Floating ball action:`,t),pt(t)});let e=null;d.ipcMain.on(`floating-ball-drag-start`,(t,n,r)=>{if(!F||F.isDestroyed())return;let[i,a]=F.getPosition(),[o,s]=F.getSize();L={winX:i,winY:a,scrX:n,scrY:r},e={w:o,h:s}}),d.ipcMain.on(`floating-ball-move`,(t,n,r)=>{if(!F||F.isDestroyed()||!L||!e||!Number.isFinite(n)||!Number.isFinite(r))return;let i=n-L.scrX,a=r-L.scrY,o=Math.round(L.winX+i),s=Math.round(L.winY+a);B({x:o,y:s,width:e.w,height:e.h});let[c,l]=F.getPosition();(c!==o||l!==s)&&B({x:o+(o-c),y:s+(s-l),width:e.w,height:e.h})}),d.ipcMain.on(`floating-ball-drag-end`,()=>{if(L=null,e=null,F&&!F.isDestroyed()){let[e,t]=F.getPosition(),[n,r]=F.getSize(),i=d.screen.getDisplayMatching(F.getBounds()).bounds,a=e,o=t;if(e-i.x<40?a=i.x:i.x+i.width-(e+n)<40&&(a=i.x+i.width-n),t-i.y<40?o=i.y:i.y+i.height-(t+r)<40&&(o=i.y+i.height-r),a!==e||o!==t){B({x:a,y:o,width:n,height:r});let[e,t]=F.getPosition();B({x:a+(a-e),y:o+(o-t),width:n,height:r}),I&&(I={x:a,y:o},qe(I)),j.info(`Floating ball snapped to edge:`,[a,o])}}I&&qe(I)}),d.ipcMain.handle(`get-floating-ball-settings`,()=>et()),d.ipcMain.handle(`set-floating-ball-settings`,(e,t)=>{let n=tt(t);if(ot(n),t.openAtLogin!==void 0)try{d.app.setLoginItemSettings({openAtLogin:t.openAtLogin})}catch(e){j.error(`setLoginItemSettings failed:`,e)}return n}),d.ipcMain.handle(`reset-floating-ball-position`,()=>{if(nt(),F&&!F.isDestroyed()){let e=d.screen.getPrimaryDisplay().bounds,t=Math.round(e.x+(e.width-R)/2),n=Math.round(e.y+(e.height-R)/2);lt=!1;try{F.webContents.executeJavaScript(`document.body.classList.remove('expanded'); var s=document.getElementById('ringSvg');if(s){while(s.firstChild){s.removeChild(s.firstChild)}} menuCreated=false; isExpanded=false; void 0;`).catch(()=>{})}catch{}B({x:t,y:n,width:R,height:R}),I={x:t,y:n};let[r,i]=F.getPosition();(r!==t||i!==n)&&B({x:t+(t-r),y:n+(n-i),width:R,height:R})}})}var gt=s(((e,t)=>{M();var n=null;function r(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e).resize({width:16,height:16})}function i(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.png`):(0,u.join)(__dirname,`../../public/logo.png`);return e?d.nativeImage.createFromPath(e).resize({width:64,height:64,quality:`better`}):d.nativeImage.createEmpty()}function a(){if(n&&!n.isDestroyed())return;n=new d.Tray(r()),n.setToolTip(`二支录制`);let e=d.Menu.buildFromTemplate([{label:`显示设置窗口`,click:()=>{process.emit(`clawd-show-settings-window`)}},{type:`separator`},{label:`退出`,click:()=>{let{app:e}=require(`electron`);e.quit()}}]);n.setContextMenu(e),n.on(`click`,()=>{process.emit(`clawd-show-settings-window`)}),j.info(`System tray created`)}function o(e,t){n&&!n.isDestroyed()&&(n.displayBalloon({title:e,content:t,icon:i()}),j.info(`Tray balloon:`,e,t))}function s(){n&&!n.isDestroyed()&&(n.destroy(),n=null)}t.exports={createTray:a,showBalloon:o,destroyTray:s}}))();M();var V=null,H=null,_t=!1,vt=!1,yt=`ai-island-settings.json`,bt={flat:!1},xt=null;function St(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),yt)}function Ct(){try{let e=g.default.readFileSync(St(),`utf-8`),t=JSON.parse(e);return{flat:typeof t.flat==`boolean`?t.flat:bt.flat}}catch{}return{...bt}}function wt(e){try{g.default.writeFileSync(St(),JSON.stringify(e),`utf-8`)}catch{}}function Tt(e){V&&!V.isDestroyed()&&V.webContents.send(`ai-island-set-flat`,e.flat)}function Et(){return xt||(xt=Ct(),xt)}function Dt(e){let t={...Et()};return typeof e.flat==`boolean`&&(t.flat=e.flat),wt(t),xt=t,Tt(t),t}function Ot(){return d.app.isPackaged?f.join(process.resourcesPath,`question-card-utils.js`):f.join(__dirname,`question-card-utils.js`)}function kt(){return`<!DOCTYPE html>
<html><head><style>
*{margin:0;padding:0;box-sizing:border-box}
html,body{height:100%;overflow:hidden;font-family:'Segoe UI',system-ui,sans-serif}
.island{
...
</style></head><body${Et().flat?` class="flat"`:``}>
<div class="island" id="island">
...
<script>
const __QCU_UTILS_PATH__=${JSON.stringify(Ot())}
...
initStatus()
<\/script>
</body></html>`}function At(){if(V&&!V.isDestroyed())return;let e=d.screen.getPrimaryDisplay().bounds;V=new d.BrowserWindow({x:Math.round(e.x+(e.width-200)/2),y:e.y+4,width:200,height:44,frame:!1,transparent:!0,resizable:!1,movable:!1,alwaysOnTop:!0,skipTaskbar:!0,hasShadow:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),V.setVisibleOnAllWorkspaces(!0),V.setMinimumSize(100,12),V.setAlwaysOnTop(!0,`screen-saver`),V.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(kt())}`),j.info(`AI island shown`)}function jt(){V&&!V.isDestroyed()&&(V.close(),V=null,j.info(`AI island hidden`))}function Mt(){d.ipcMain.handle(`get-ai-island-settings`,()=>Et()),d.ipcMain.handle(`set-ai-island-settings`,(e,t)=>Dt(t)),d.ipcMain.on(`resize-ai-island`,(e,t,n)=>{if(!V||V.isDestroyed()||!Number.isFinite(t))return;let r=t+20,i=Number.isFinite(n)?n:44;if(!(!Number.isFinite(r)||!Number.isFinite(i)))if(Et().flat){let e=d.screen.getDisplayMatching(V.getBounds()).bounds,n=Math.round(e.x+(e.width-t)/2);if(!Number.isFinite(n))return;V.setBounds({x:n,y:e.y,width:t,height:i})}else if(_t){let[e,t]=V.getPosition();if(!Number.isFinite(e)||!Number.isFinite(t))return;V.setBounds({x:e,y:t,width:r,height:i})}else{let e=d.screen.getPrimaryDisplay().bounds,t=Math.round(e.x+(e.width-r)/2),n=e.y+4;if(!Number.isFinite(t)||!Number.isFinite(n))return;V.setBounds({x:t,y:n,width:r,height:i})}}),d.ipcMain.on(`ai-island-drag-start`,(e,t,n)=>{if(!V||V.isDestroyed()||!Number.isFinite(t)||!Number.isFinite(n))return;let[r,i]=V.getPosition();H={winX:r,winY:i,scrX:t,scrY:n}}),d.ipcMain.on(`ai-island-drag-move`,(e,t,n)=>{if(!V||V.isDestroyed()||!H||!Number.isFinite(t)||!Number.isFinite(H.scrX)||!Number.isFinite(H.winX)||!Number.isFinite(H.winY))return;let r=t-H.scrX,i=Math.round(H.winX+r);if(!Number.isFinite(i))return;let[a,o]=V.getSize();V.setBounds({x:i,y:H.winY,width:a,height:o})}),d.ipcMain.on(`ai-island-drag-end`,()=>{H=null,Et().flat||(_t=!0)}),d.ipcMain.on(`set-ai-island-mouse-mode`,(e,t)=>{if(!V||V.isDestroyed())return;let n=!t;n!==vt&&(vt=n,V.setIgnoreMouseEvents(n,{forward:!0}))})}var Nt={info:()=>{},warn:()=>{},error:()=>{}},Pt=null,Ft=`todo-notes.json`,It=`todo-settings.json`;function Lt(){if(Pt)return Pt;let{app:e}=require(`electron`);return e.getPath(`userData`)}function Rt(){return(0,u.join)(Lt(),Ft)}function zt(){return(0,u.join)(Lt(),It)}function Bt(){try{let e=g.readFileSync(Rt(),`utf-8`),t=JSON.parse(e);if(Array.isArray(t.items))return{items:t.items.filter(e=>e&&typeof e.id==`string`),meta:{schemaVersion:t.meta?.schemaVersion??1}}}catch{}return{items:[],meta:{schemaVersion:1}}}function U(){return Bt().items}function Vt(e){let t=Rt(),n=t+`.tmp`;try{g.writeFileSync(n,JSON.stringify(e,null,2),`utf-8`),g.renameSync(n,t)}catch{try{g.writeFileSync(t,JSON.stringify(e,null,2),`utf-8`)}catch(e){Nt.error(`todo store save failed:`,e?.message??e)}}}function Ht(e){Vt({items:e,meta:{schemaVersion:1}})}function Ut(e){let t=U(),n=Date.now(),r={id:(0,b.randomUUID)(),type:e.type,title:e.title??``,content:e.content??``,priority:e.priority??`medium`,reminder:e.reminder??null,reminderFired:!1,done:e.done??!1,pinned:!1,pinX:null,pinY:null,createdAt:n,updatedAt:n};return t.unshift(r),Ht(t),t}function Wt(e,t){let n=U(),r=n.find(t=>t.id===e);return r?(Object.assign(r,t,{updatedAt:Date.now()}),Ht(n),n):n}function Gt(e,t){let n=U(),r=n.find(t=>t.id===e);return r?(t.reminder!==void 0&&t.reminder!==r.reminder&&(r.reminderFired=!1),Object.assign(r,t,{updatedAt:Date.now()}),Ht(n),n):n}function Kt(e){let t=U().filter(t=>t.id!==e);return Ht(t),t}function qt(e){let t=U(),n=t.find(t=>t.id===e);return n&&n.type===`todo`&&(n.done=!n.done,n.updatedAt=Date.now(),Ht(t)),t}function Jt(e){return Wt(e,{reminderFired:!0})}function Yt(e,t){let n=U(),r=n.find(t=>t.id===e);return r?(r.pinned=!r.pinned,r.pinned&&t&&(r.pinX=Math.round(t.x),r.pinY=Math.round(t.y)),r.updatedAt=Date.now(),Ht(n),n):n}function Xt(e){return e.filter(e=>e.type===`todo`&&!e.done).length}var Zt={badgeVisible:!0,windowAlwaysOnTop:!0,stickyBoardPos:null};function Qt(){try{let e=JSON.parse(g.readFileSync(zt(),`utf-8`));return{badgeVisible:typeof e.badgeVisible==`boolean`?e.badgeVisible:Zt.badgeVisible,windowAlwaysOnTop:typeof e.windowAlwaysOnTop==`boolean`?e.windowAlwaysOnTop:Zt.windowAlwaysOnTop,stickyBoardPos:e.stickyBoardPos&&typeof e.stickyBoardPos.x==`number`&&typeof e.stickyBoardPos.y==`number`?{x:e.stickyBoardPos.x,y:e.stickyBoardPos.y}:null}}catch{return{...Zt}}}function $t(e){let t={...Qt(),...e};try{g.writeFileSync(zt(),JSON.stringify(t,null,2),`utf-8`)}catch(e){Nt.error(`todo settings save failed:`,e?.message??e)}return t}var en=!1;function W(){let e=Xt(U()),t=Qt().badgeVisible;at(e,en,t)}function tn(e){en=e,W()}function nn(){tn(!1)}function rn(){d.ipcMain.on(`floating-ball-badge-ready`,()=>{W()})}M();var G=null;function an(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`..`,`..`,`public`,`logo.ico`);return d.nativeImage.createFromPath(e)}function on(){if(G&&!G.isDestroyed()){G.show(),G.focus(),nn();return}let e=process.env.VITE_DEV_SERVER_URL,t=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);G=new d.BrowserWindow({icon:an(),width:525,height:450,minWidth:320,minHeight:360,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`待办便签`,backgroundColor:`#eaeaec`,webPreferences:{preload:t,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),G.setAlwaysOnTop(Qt().windowAlwaysOnTop,`normal`),e?G.loadURL(`${e}#/todo?t=${Date.now()}`):G.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/todo`}),G.once(`ready-to-show`,()=>{G?.show()}),G.on(`closed`,()=>{G=null}),nn(),j.info(`Todo window shown`)}function sn(){G&&!G.isDestroyed()&&G.close(),G=null}function cn(){return!!(G&&!G.isDestroyed())}function ln(){let e=!Qt().windowAlwaysOnTop;return $t({windowAlwaysOnTop:e}),G&&!G.isDestroyed()&&G.setAlwaysOnTop(e,`normal`),e}function un(e){if(on(),!G||G.isDestroyed())return;let t=()=>{G&&!G.isDestroyed()&&G.webContents.send(`todo-focus-item`,e)};G.webContents.isLoading()?G.webContents.once(`did-finish-load`,t):t()}M();var K=null;function dn(e,t){let n=Ue(32);return`<!DOCTYPE html><html><head><meta charset="utf-8"><style>
*{margin:0;padding:0;box-sizing:border-box;user-select:none}
...
.open:hover{background:#404db9}
  ...
  <div class="body">
    <div class="t">${fn(e)||`待办提醒`}</div>
    <div class="b">${fn(t)||`到时间了，记得处理一下。`}</div>
...
<\/script></body></html>`}function fn(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}var pn=[];function mn(e,t){pn.push({title:e,body:t}),hn()}function hn(){if(K&&!K.isDestroyed())return;let e=pn.shift();e&&gn(e.title,e.body)}function gn(e,t){let n=d.screen.getPrimaryDisplay().workArea;K=new d.BrowserWindow({x:n.x+n.width-300-16,y:n.y+n.height-150-16,width:300,height:150,frame:!1,transparent:!0,backgroundColor:`#00000000`,resizable:!1,movable:!1,alwaysOnTop:!0,skipTaskbar:!0,hasShadow:!1,show:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),K.setAlwaysOnTop(!0,`screen-saver`),K.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(dn(e,t))}`),K.once(`ready-to-show`,()=>K?.show()),K.on(`closed`,()=>{K=null,hn()}),j.info(`Todo reminder popup shown`)}function _n(){K&&!K.isDestroyed()&&K.destroy()}function vn(){pn.length=0,K&&!K.isDestroyed()&&K.destroy(),K=null}function yn(e){return e?String(e).replace(/<img[^>]*alt=["']([^"']*)["'][^>]*>/gi,(e,t)=>t||`[图]`).replace(/<img[^>]*>/gi,`[图]`).replace(/<br\s*\/?>/gi,` `).replace(/<\/(p|div|h[1-6]|li|blockquote)>/gi,` `).replace(/<[^>]+>/gi,``).replace(/&nbsp;/g,` `).replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`).replace(/&quot;/g,`"`).replace(/&#39;/g,`'`).replace(/\s+/g,` `).trim():``}var bn=208,xn=120,q=null,Sn=0;function Cn(){return U().filter(e=>e.pinned).map(e=>{let t=yn(e.content).trim(),n=e.type===`memo`?yn(e.title).trim():``;return{id:e.id,title:n||t,body:n?t:``,done:e.done,priority:e.priority}})}function wn(){let e=d.screen.getPrimaryDisplay().workArea;return{x:e.x+e.width-bn-16,y:e.y+e.height-xn-16}}function Tn(){return`<!DOCTYPE html><html><head><meta charset="utf-8"><style>
*{margin:0;padding:0;box-sizing:border-box;user-select:none}
html,body{width:100%;height:100%;overflow:hidden;background:transparent;font-family:'Segoe UI',system-ui,sans-serif}
...
<\/script></body></html>`}function En(){let e=Qt().stickyBoardPos??wn();q=new d.BrowserWindow({x:e.x,y:e.y,width:bn,height:xn,frame:!1,transparent:!0,backgroundColor:`#00000000`,resizable:!1,alwaysOnTop:!0,skipTaskbar:!0,hasShadow:!1,show:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),q.setAlwaysOnTop(!0,`screen-saver`),q.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(Tn())}`),q.once(`ready-to-show`,()=>{q&&!q.isDestroyed()&&(q.show(),Dn())}),q.on(`move`,()=>{if(!q||q.isDestroyed())return;let[e,t]=q.getPosition();J&&clearTimeout(J),J=setTimeout(()=>{J=null,$t({stickyBoardPos:{x:e,y:t}})},300)}),q.on(`closed`,()=>{q=null})}var J=null;function Y(){let e=Cn();if(e.length===0){q&&!q.isDestroyed()&&q.destroy(),q=null;return}Sn=Math.max(0,Math.min(Sn,e.length-1)),!q||q.isDestroyed()?En():Dn()}function Dn(){let e=Cn();!q||q.isDestroyed()||q.webContents.executeJavaScript(`if(window.renderNotes) renderNotes(${JSON.stringify(e)}, ${Sn})`).catch(()=>{})}function On(){J&&=(clearTimeout(J),null),q&&!q.isDestroyed()&&q.destroy(),q=null}M();var{updateAudioLevels:kn}=Be();function An(){return(0,u.join)(d.app.getPath(`userData`),`recordings.json`)}function jn(e){(0,Ve.registerRegionSelectorHandlers)(),ht(),Mt(),d.ipcMain.handle(`show-ai-island`,()=>{At()}),d.ipcMain.handle(`hide-ai-island`,()=>{jt()}),d.ipcMain.handle(`select-region`,async()=>(0,Ve.selectRegion)()),d.ipcMain.handle(`get-sources`,async(e,t)=>(await d.desktopCapturer.getSources({types:t??[`screen`,`window`],thumbnailSize:{width:340,height:200},fetchWindowIcons:!0})).map(e=>({id:e.id,name:e.name,display_id:e.display_id,appIcon:e.appIcon?.toDataURL()||null,thumbnail:e.thumbnail.toDataURL()}))),d.ipcMain.handle(`get-system-audio-sources`,async()=>{try{return(await d.desktopCapturer.getSources({types:[`audio`]})).map(e=>({id:e.id,name:e.name}))}catch{return[]}}),d.ipcMain.handle(`show-save-dialog`,async(e,t)=>{let n=d.BrowserWindow.getFocusedWindow();return n?d.dialog.showSaveDialog(n,{title:t?.title??`Save Recording`,defaultPath:t?.defaultPath??`recording-${Date.now()}.webm`,filters:t?.filters??[{name:`WebM Video`,extensions:[`webm`]},{name:`MP4 Video`,extensions:[`mp4`]},{name:`GIF`,extensions:[`gif`]}]}):{canceled:!0,filePath:null}}),d.ipcMain.handle(`show-open-dialog`,async(e,t)=>{let n=d.BrowserWindow.getFocusedWindow();return n?d.dialog.showOpenDialog(n,{title:t?.title??`Select File`,defaultPath:t?.defaultPath,filters:t?.filters??[{name:`Video Files`,extensions:[`webm`,`mp4`,`gif`]}],properties:t?.properties}):{canceled:!0,filePaths:[]}}),d.ipcMain.handle(`get-default-save-dir`,async()=>d.app.getPath(`videos`)||d.app.getPath(`desktop`)),d.ipcMain.handle(`write-file`,async(e,t,n)=>{try{return await g.default.promises.mkdir((0,u.dirname)(n),{recursive:!0}),await g.default.promises.writeFile(n,t),j.info(`保存文件`,n),{success:!0,filePath:n}}catch(e){return j.error(`保存文件失败`,n,e.message),{success:!1,filePath:n,error:e.message}}}),d.ipcMain.handle(`read-file`,async(e,t)=>{try{return(await g.default.promises.readFile(t)).buffer}catch(e){throw Error(`Failed to read file: ${e.message}`)}}),d.ipcMain.handle(`file-exists`,async(e,t)=>{try{return await g.default.promises.access(t),!0}catch{return!1}}),d.ipcMain.handle(`delete-file`,async(e,t)=>{try{return await g.default.promises.unlink(t),!0}catch{return!1}}),d.ipcMain.handle(`get-file-size`,async(e,t)=>{try{return(await g.default.promises.stat(t)).size}catch{return 0}});function t(e,t,...n){if(!(!e||e.isDestroyed()))try{e.webContents.send(t,...n)}catch{}}d.ipcMain.handle(`convert-to-mp4`,async(e,n,r,i)=>{j.info(`转换为 MP4`,n,`->`,r,i?`crop: ${i.width}x${i.height}`:``);let a=d.BrowserWindow.fromWebContents(e.sender);return Ie(n,r,e=>{t(a,`on-conversion-progress`,e)},i)}),d.ipcMain.handle(`crop-video`,async(e,n,r,i)=>{j.info(`裁剪视频`,n,`->`,r,`crop: ${i.width}x${i.height}+${i.x}+${i.y}`);let a=d.BrowserWindow.fromWebContents(e.sender);return Le(n,r,i,e=>{t(a,`on-conversion-progress`,e)})}),d.ipcMain.handle(`convert-to-gif`,async(e,n,r,i)=>{j.info(`转换为 GIF`,n,`->`,r);let a=d.BrowserWindow.fromWebContents(e.sender);return ze(n,r,i,e=>{t(a,`on-conversion-progress`,e)})}),d.ipcMain.handle(`merge-multi-screen`,async(e,n,r)=>{j.info(`合并多屏录制`,n.length,`个屏幕 ->`,r);let i=d.BrowserWindow.fromWebContents(e.sender);return Re(n,r,e=>{t(i,`on-conversion-progress`,e)})}),d.ipcMain.handle(`open-file-location`,async(e,t)=>{d.shell.showItemInFolder(t)}),d.ipcMain.handle(`open-external`,async(e,t)=>{d.shell.openExternal(t)}),d.ipcMain.handle(`open-path`,async(e,t)=>{await d.shell.openPath(t)}),d.ipcMain.handle(`get-app-version`,async()=>d.app.getVersion()),d.ipcMain.handle(`get-screen-scale-factor`,async()=>d.screen.getPrimaryDisplay().scaleFactor),d.ipcMain.handle(`get-screen-bounds`,async()=>{let e=d.screen.getPrimaryDisplay(),t=e.scaleFactor;return{x:Math.round(e.bounds.x/t),y:Math.round(e.bounds.y/t),width:Math.round(e.bounds.width/t),height:Math.round(e.bounds.height/t)}}),d.ipcMain.handle(`take-screenshot`,async e=>{try{let e=await d.desktopCapturer.getSources({types:[`screen`],thumbnailSize:{width:0,height:0}});if(!e.length)throw Error(`未找到屏幕源`);let t=e[0].thumbnail.toPNG(),n=new Date,r=`截图_${n.getFullYear()}${String(n.getMonth()+1).padStart(2,`0`)}${String(n.getDate()).padStart(2,`0`)}_${String(n.getHours()).padStart(2,`0`)}${String(n.getMinutes()).padStart(2,`0`)}${String(n.getSeconds()).padStart(2,`0`)}.png`,i=(0,u.join)(d.app.getPath(`desktop`),r);return await g.default.promises.writeFile(i,t),(0,gt.showBalloon)(`二支录制`,`截图已保存到桌面：${r}`),{success:!0,filePath:i}}catch(e){return j.error(`截图失败`,e.message),{success:!1,error:e.message}}}),d.ipcMain.handle(`get-all-displays`,async()=>{let e=d.screen.getAllDisplays(),t=d.screen.getPrimaryDisplay(),n=await d.desktopCapturer.getSources({types:[`screen`],thumbnailSize:{width:340,height:200}});return e.map((e,r)=>{let i=n[r];return{id:e.id,label:e.id===t.id?`主屏幕`:`屏幕 ${r+1}`,bounds:e.bounds,scaleFactor:e.scaleFactor,size:{width:e.size.width,height:e.size.height},isPrimary:e.id===t.id,sourceId:i?.id||null,sourceName:i?.name||``,thumbnail:i?.thumbnail?.toDataURL()||``}})}),d.ipcMain.handle(`minimize-window`,async e=>{d.BrowserWindow.fromWebContents(e.sender)?.minimize()}),d.ipcMain.handle(`show-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t&&(t.show(),t.focus())}),d.ipcMain.handle(`maximize-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t?.isMaximized()?t.unmaximize():t?.maximize()}),d.ipcMain.handle(`close-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t&&t.hide()}),d.ipcMain.on(`notify-conversion-start`,()=>{(0,gt.showBalloon)(`二支录制`,`录制完成，正在转换视频格式...`)}),d.ipcMain.on(`show-about-window`,()=>{let e=d.BrowserWindow.getFocusedWindow();if(e){let t=new d.BrowserWindow({width:360,height:400,resizable:!1,skipTaskbar:!0,frame:!1,modal:!0,parent:e,backgroundColor:`#eaeaec`,webPreferences:{preload:(0,u.join)(__dirname,`..`,`preload`,`index.cjs`),contextIsolation:!0,nodeIntegration:!1,sandbox:!1}});d.ipcMain.on(`close-about-window`,()=>{t.close(),d.ipcMain.removeAllListeners(`close-about-window`)}),t.on(`closed`,()=>{d.ipcMain.removeAllListeners(`close-about-window`)});let n=process.env.VITE_DEV_SERVER_URL?`${process.env.VITE_DEV_SERVER_URL}about.html`:(0,u.join)(d.app.getAppPath(),`dist`,`about.html`);n.startsWith(`http`)?t.loadURL(n):t.loadFile(n)}}),d.ipcMain.on(`notify-conversion-done`,()=>{(0,gt.showBalloon)(`二支录制`,`视频转换完成！`)}),d.ipcMain.on(`update-audio-levels`,(e,t,n)=>{kn(t,n)}),d.ipcMain.handle(`load-recordings`,async()=>{let e=An();try{let t=await g.default.promises.readFile(e,`utf-8`),n=JSON.parse(t);return j.info(`加载录制历史`,e,n.length,`条`),n}catch(t){return j.info(`加载录制历史失败（可能首次运行）`,e,t.message),[]}}),d.ipcMain.handle(`save-recordings`,async(e,t)=>{let n=An();try{return await g.default.promises.writeFile(n,JSON.stringify(t),`utf-8`),j.info(`保存录制历史`,n,t.length,`条`),!0}catch(e){return j.error(`保存录制历史失败`,n,e.message),!1}}),e&&(e.setStateListener((e,t)=>{(e!==`idle`||t&&t.length>0)&&At();let n=d.BrowserWindow.getAllWindows();for(let r of n)if(!r.isDestroyed())try{r.webContents.send(`agent-state-update`,{state:e,sessions:t})}catch{}}),e.setCardListener(e=>{e&&At();let t;t=e?e.kind===`permission`?{kind:`permission`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,suggestions:e.suggestions,createdAt:e.createdAt}:{kind:`question`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,questions:e.questions,answerable:e.answerable,createdAt:e.createdAt}:null,j.info(`[IPC] broadcast card: kind=${e?e.kind:`null`}, wins=${d.BrowserWindow.getAllWindows().length}`);let n=d.BrowserWindow.getAllWindows();for(let e of n)if(!e.isDestroyed())try{e.webContents.send(`agent-card-update`,t)}catch(e){j.error(`[IPC] send card to window failed: ${e.message}`)}}),d.ipcMain.handle(`agent-get-status`,()=>{let t=e?.getStatus()??null;return j.info(`[IPC] agentGetStatus: sessionCount=${t?.sessionCount}, displayState=${t?.displayState}, serverRunning=${t?.serverRunning}`),t}),d.ipcMain.handle(`agent-install-hooks`,()=>(e?.installHooks(),e?.getStatus())),d.ipcMain.handle(`agent-uninstall-hooks`,()=>(e?.uninstallHooks(),e?.getStatus())),d.ipcMain.handle(`agent-resolve-permission`,(t,n)=>e?.resolvePermission(n)),d.ipcMain.handle(`agent-dismiss-question`,()=>e?.dismissQuestion()),d.ipcMain.handle(`agent-submit-question`,(t,n,r)=>e?.submitQuestion(n,r)),d.ipcMain.handle(`agent-set-auto-allow`,(t,n)=>e?.setAutoAllow(n)),d.ipcMain.handle(`agent-get-auto-allow`,()=>e?.getAutoAllow()??!1)),Mn()}function Mn(){d.ipcMain.handle(`todo-get`,()=>U()),d.ipcMain.handle(`todo-create`,(e,t)=>{let n=Ut(t);return W(),Y(),n}),d.ipcMain.handle(`todo-update`,(e,t,n)=>{let r=Gt(t,n);return W(),Y(),r}),d.ipcMain.handle(`todo-delete`,(e,t)=>{let n=Kt(t);return W(),Y(),n}),d.ipcMain.handle(`todo-toggle-done`,(e,t)=>{let n=qt(t);return W(),Y(),n}),d.ipcMain.handle(`todo-toggle-pin`,(e,t)=>{let n=Yt(t);return Y(),W(),n}),d.ipcMain.handle(`todo-show-window`,()=>{on()}),d.ipcMain.handle(`todo-close-window`,()=>{sn()}),d.ipcMain.handle(`todo-window-visible`,()=>cn()),d.ipcMain.handle(`todo-toggle-always-on-top`,()=>ln()),d.ipcMain.handle(`todo-get-settings`,()=>Qt()),d.ipcMain.handle(`todo-set-settings`,(e,t)=>{let n=$t(t);return W(),n}),d.ipcMain.on(`todo-reminder-close`,()=>{_n()}),d.ipcMain.on(`todo-reminder-open`,()=>{vn(),on()}),d.ipcMain.on(`todo-sticky-open`,(e,t)=>{un(t)}),d.ipcMain.on(`todo-sticky-unpin`,(e,t)=>{Yt(t),Y(),W()})}M();var Nn=null;function Pn(e){Nn=e,d.globalShortcut.register(`CommandOrControl+Shift+R`,()=>{j.info(`Global shortcut: start/stop recording`),Nn?.webContents.send(`on-global-shortcut`,`startStop`)}),d.globalShortcut.register(`CommandOrControl+Shift+P`,()=>{j.info(`Global shortcut: pause/resume recording`),Nn?.webContents.send(`on-global-shortcut`,`pauseResume`)}),j.info(`Global shortcuts registered`)}function Fn(){d.globalShortcut.unregisterAll()}M();var In=`http://8.163.43.7:3000/report-ip`;function X(){return(0,u.join)(d.app.getPath(`userData`),`pending-reports.json`)}function Ln(e){let t=[];try{g.default.existsSync(X())&&(t=JSON.parse(g.default.readFileSync(X(),`utf-8`)))}catch{}t.push(e),g.default.writeFileSync(X(),JSON.stringify(t,null,2),`utf-8`),j.info(`Saved offline report to local, total pending:`,t.length)}function Rn(){try{if(g.default.existsSync(X()))return JSON.parse(g.default.readFileSync(X(),`utf-8`))}catch{}return[]}function zn(){try{g.default.unlinkSync(X())}catch{}}async function Bn(e){try{return await fetch(In,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),!0}catch{return!1}}async function Vn(){let e=Rn();if(e.length===0)return!0;let t=[];for(let n of e)await Bn(n)?j.info(`Flushed pending report:`,n.公网IP,n.上报时间):t.push(n);return t.length===0?(zn(),j.info(`All pending reports flushed`),!0):(g.default.writeFileSync(X(),JSON.stringify(t,null,2),`utf-8`),!1)}async function Hn(){let e=[async()=>{let e=(await fetch(`https://qifu.baidu.com/opus/api/ip/local`,{headers:{Referer:`https://www.baidu.com`}}).then(e=>e.json()))?.data;if(!e?.ip)throw Error(`empty`);return{公网IP:e.ip,国家:e.country||``,省份:e.province||``,城市:e.city||``,区县:e.district||e.area||``,详细地址:[e.country,e.province,e.city,e.district||e.area].filter(Boolean).join(``),运营商:e.isp||``}},async()=>{let e=await fetch(`http://whois.pconline.com.cn/ipJson.jsp`).then(e=>e.arrayBuffer()),t=new TextDecoder(`gbk`).decode(e),n=JSON.parse(t);if(!n.ip)throw Error(`empty`);return{公网IP:n.ip,国家:`中国`,省份:n.pro||``,城市:n.city||``,区县:n.region||``,详细地址:n.addr||``,运营商:n.addr?.split(` `)?.[1]||``}},async()=>{let e=await fetch(`http://ip-api.com/json/?lang=zh-CN`).then(e=>e.json());if(!e.query)throw Error(`empty`);return{公网IP:e.query,国家:e.country,省份:e.regionName,城市:e.city,区县:``,详细地址:`${e.country}${e.regionName}${e.city}`,运营商:e.isp,纬度:String(e.lat??``),经度:String(e.lon??``)}}];for(let t of e)try{return await t()}catch{continue}return{公网IP:``,国家:``,省份:``,城市:``,区县:``,详细地址:``,运营商:``}}function Un(){let e=(0,y.networkInterfaces)();for(let t of Object.keys(e))for(let n of e[t])if(n.family===`IPv4`&&!n.internal)return n.address;return`127.0.0.1`}async function Wn(){let e=Un(),t={电脑名:(0,y.hostname)(),局域网IP:e,上报时间:new Date().toISOString()},n;try{n=await Hn()}catch{n={公网IP:``,国家:``,省份:``,城市:``,区县:``,详细地址:``,运营商:``}}let r={...t,...n};await Bn(r)?(j.info(`IP reported:`,n.公网IP,n.省份,n.城市),Vn()):(j.info(`Network unavailable, saving report locally`),Ln(r))}function Gn(){Rn().length>0&&Vn()}M();var Kn={error:4,notification:3,working:2,thinking:1,idle:0},qn=600*1e3,Jn=300*1e3,Yn=10*1e3,Xn=2e3;function Zn(){let e=new Map,t=null,n=[],r=null,i=`idle`;function a(e){return n.push(e),()=>{n=n.filter(t=>t!==e)}}function o(){let t=l(),r=Array.from(e.values());t!==i&&(i=t);for(let e of n)e(i,r)}function s(t,n,i,a={}){r&&=(clearTimeout(r),null);let s=e.get(t),c={sessionId:t,agentId:a.agentId||`claude-code`,state:n,event:i,updatedAt:Date.now(),toolName:a.toolName||s?.toolName,toolInput:a.toolInput||s?.toolInput,contextUsage:a.contextUsage||s?.contextUsage,model:a.model||s?.model};e.set(t,c),j.info(`[StateMachine] updateSession: id=${t}, state=${n}, event=${i}, total=${e.size}`),n===`idle`&&i===`Stop`&&(r=setTimeout(()=>{if(r=null,e.has(t)){let n=e.get(t);n.state=`idle`,n.updatedAt=Date.now()}j.info(`[StateMachine] doneTimer fired for ${t}, total=${e.size}`),o()},Xn)),o()}function c(t){e.delete(t),o()}function l(){let t=`idle`;for(let[,n]of e)(Kn[n.state]??0)>(Kn[t]??0)&&(t=n.state);return r&&t===`idle`?`done`:t}function u(){return i}function d(){let t=[];for(let[,n]of e)t.push(n);return t}function f(){let t=Date.now(),n=!1;for(let[r,i]of e){let a=t-i.updatedAt;a>qn?(e.delete(r),j.info(`[StateMachine] cleanStale: removed ${r} (age=${Math.round(a/1e3)}s)`),n=!0):i.state!==`idle`&&a>Jn&&(i.state=`idle`,i.updatedAt=t,j.info(`[StateMachine] cleanStale: reset ${r} to idle (age=${Math.round(a/1e3)}s)`),n=!0)}n&&o()}function p(){t||=setInterval(f,Yn)}function m(){t&&=(clearInterval(t),null),r&&=(clearTimeout(r),null)}return{updateSession:s,dismissSession:c,resolveDisplayState:l,getCurrentState:u,getSessions:d,subscribe:a,cleanStaleSessions:f,start:p,stop:m}}function Qn(e){return e==null?`null`:typeof e==`object`?Array.isArray(e)?`[`+e.map(Qn).join(`,`)+`]`:`{`+Object.keys(e).sort().map(t=>JSON.stringify(t)+`:`+Qn(e[t])).join(`,`)+`}`:JSON.stringify(e)}function $n(e,t,n){let r=n?.tool_use_id||n?.toolUseId||null,i=n?.tool_name||n?.toolName||null,a=i!=null&&i!==``?Qn(n?.tool_input??n?.toolInput??null):null;for(let n=0;n<e.length;n++){let o=e[n];if(o.kind===`permission`&&o.sessionId===t&&(r&&o.toolUseId&&o.toolUseId===r||a!=null&&o.toolName===i&&Qn(o.toolInput??null)===a))return n}return-1}M();var er=6e4,tr=60019,nr=12e4,rr=null;function ir(){return rr||(rr=f.join(require(`os`).homedir(),`.erzhi-recording`),rr)}function ar(e){let t=null,n=null,r=[],i=null,a=null,o=[`PostToolUse`,`PostToolUseFailure`,`Stop`,`StopFailure`,`SessionEnd`,`ApiError`],s=[`PostToolUse`,`PostToolUseFailure`,`PermissionDenied`],c=[`Stop`,`StopFailure`,`SessionEnd`];class l extends Error{code=`PAYLOAD_TOO_LARGE`}function u(e){return new Promise((t,n)=>{let r=``;e.on(`data`,t=>{if(r+=t,Buffer.byteLength(r)>1048576){try{e.destroy()}catch{}n(new l(`Body exceeds 1MB limit`))}}),e.on(`end`,()=>{try{t(JSON.parse(r))}catch{n(Error(`Invalid JSON`))}}),e.on(`error`,n)})}function d(e,t,n){e.writeHead(t,{"Content-Type":`application/json`}),e.end(JSON.stringify(n))}function p(e,t){try{!e.headersSent&&!e.destroyed&&!e.writableEnded&&(e.writeHead(200,{"Content-Type":`application/json`}),e.end(t))}catch{}}function g(){return r[0]??null}function _(e){let t=g();t&&((t.kind===`permission`||t.answerable)&&t.reject(e),v())}function v(){r.shift(),clearTimeout(i),i=null,y(),b()}function y(){if(i&&clearTimeout(i),!r.length){i=null;return}i=setTimeout(()=>{i=null,_(`timeout`)},nr)}function b(){a&&a(g())}function x(e){let t=r.length,n=[],a=r.filter(t=>t.kind===`question`&&t.sessionId===e?(n.push(t),!1):!0);if(a.length!==t){r=a;for(let e of n)e.kind===`question`&&e.answerable&&e.reject(`completed`);clearTimeout(i),i=null,y(),b()}}function S(e,t){let n=$n(r,e,t);if(n===-1)return;let[a]=r.splice(n,1);a.reject(`resolved-in-cli`),clearTimeout(i),i=null,y(),b(),j.info(`[AgentServer] permission resolved externally (CLI): session=${e}, tool=${a.toolName}`)}function C(e){let t=r.length,n=[],a=r.filter(t=>t.kind===`permission`&&t.sessionId===e?(n.push(t),!1):!0);if(a.length!==t){r=a;for(let e of n)e.reject(`completed`);clearTimeout(i),i=null,y(),b(),j.info(`[AgentServer] permissions cleared for ended session=${e}, count=${n.length}`)}}function ee(t,n){let r=t.session_id||t.sessionId,i=t.state,a=t.event;if(j.info(`[AgentServer] /state received: session=${r}, state=${i}, event=${a}, tool=${t.tool_name||t.toolName}`),!r||!i||!a){j.warn(`[AgentServer] /state rejected: missing fields (sessionId=${r}, state=${i}, event=${a})`),d(n,400,{error:`Missing required fields: session_id, state, event`});return}e.updateSession(r,i,a,{agentId:t.agent_id||`claude-code`,toolName:t.tool_name||t.toolName,toolInput:t.tool_input||t.toolInput,contextUsage:t.context_usage||t.contextUsage,model:t.model}),o.includes(a)&&x(r),c.includes(a)&&C(r),s.includes(a)&&S(r,t),j.info(`[AgentServer] /state ok, total sessions=${e.getSessions().length}`),d(n,200,{ok:!0,app:`erzhi-recording`})}function te(t,n){let i=t.tool_name||t.toolName||`unknown`,a=t.tool_input||t.toolInput||{},o=t.session_id||t.sessionId||`unknown`;if(i===`AskUserQuestion`){w(n,o,a);return}e.updateSession(o,`notification`,`PermissionRequest`,{toolName:i,toolInput:a});let s=t.tool_use_id||t.toolUseId||null,c={kind:`permission`,sessionId:o,toolName:i,toolInput:a,suggestions:t.permission_suggestions||null,toolUseId:s,resolve:()=>{},reject:()=>{},createdAt:Date.now()};new Promise((e,t)=>{c.resolve=e,c.reject=t}).then(t=>{e.updateSession(o,`idle`,`PermissionResolved`);let r=t===`always`?`allow`:t,i=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:r}}});j.info(`[AgentServer] /permission resolved: behavior=${t} -> ${r}`),p(n,i)}).catch(t=>{e.updateSession(o,`idle`,`PermissionCancelled`);let r=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:`cancel`}}});j.info(`[AgentServer] /permission cancelled: ${t}`),p(n,r)}),r.push(c),r.length===1&&y(),b(),j.info(`[AgentServer] /permission queued: session=${o}, queue=${r.length}`)}function w(t,n,i){let a=Array.isArray(i&&i.questions)&&i.questions||null;e.updateSession(n,`notification`,`AskUserQuestion`,{toolName:`AskUserQuestion`,toolInput:i});let o={kind:`question`,sessionId:n,toolName:`AskUserQuestion`,toolInput:i,questions:a,answerable:!0,resolve:()=>{},reject:()=>{},createdAt:Date.now()};new Promise((e,t)=>{o.resolve=e,o.reject=t}).then(r=>{e.updateSession(n,`idle`,`QuestionAnswered`);let i=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:`allow`,updatedInput:{questions:a,answers:r}}}});j.info(`[AgentServer] AskUserQuestion answered via /permission: session=${n}`),p(t,i)}).catch(r=>{e.updateSession(n,`idle`,`QuestionDenied`);let i=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:`deny`}}});j.info(`[AgentServer] AskUserQuestion denied: reason=${r}, session=${n}`),p(t,i)}),r.push(o),r.length===1&&y(),b(),j.info(`[AgentServer] AskUserQuestion (answerable) queued: session=${n}, queue=${r.length}`)}function T(t,n){let r=t.session_id||t.sessionId||`unknown`,i=t.tool_name||t.toolName||`AskUserQuestion`,a=t.tool_input||t.toolInput||{};e.updateSession(r,`notification`,`AskUserQuestion`,{toolName:i,toolInput:a}),j.info(`[AgentServer] /question notified (read-only card removed): session=${r}`),d(n,200,{ok:!0,app:`erzhi-recording`})}function E(t){let r=e.getSessions().length;d(t,200,{ok:!0,app:`erzhi-recording`,port:n,sessionCount:r})}function D(e,t){t.setHeader(`Access-Control-Allow-Origin`,`*`),j.info(`[AgentServer] ${e.method} ${e.url}`),e.method===`POST`&&e.url===`/state`?u(e).then(e=>ee(e,t)).catch(e=>{j.error(`[AgentServer] parseBody error:`,e),d(t,e?.code===`PAYLOAD_TOO_LARGE`?413:400,{error:e?.code===`PAYLOAD_TOO_LARGE`?`Payload too large`:`Invalid JSON`})}):e.method===`POST`&&e.url===`/permission`?u(e).then(e=>te(e,t)).catch(e=>{j.error(`[AgentServer] parseBody error:`,e),d(t,e?.code===`PAYLOAD_TOO_LARGE`?413:400,{error:e?.code===`PAYLOAD_TOO_LARGE`?`Payload too large`:`Invalid JSON`})}):e.method===`POST`&&e.url===`/question`?u(e).then(e=>T(e,t)).catch(e=>{j.error(`[AgentServer] parseBody error:`,e),d(t,e?.code===`PAYLOAD_TOO_LARGE`?413:400,{error:e?.code===`PAYLOAD_TOO_LARGE`?`Payload too large`:`Invalid JSON`})}):e.method===`GET`&&e.url===`/health`?E(t):d(t,404,{error:`Not found`})}function ne(e){let t=g();t&&t.kind===`permission`&&(t.resolve(e),v())}function re(){let e=g();e&&e.kind===`question`&&(e.answerable&&e.reject(`dismissed`),v())}function ie(e,t){let n=g();n&&n.kind===`question`&&n.answerable&&n.sessionId===e?(n.resolve(t),v(),j.info(`[AgentServer] submitQuestion accepted: session=${e}`)):j.warn(`[AgentServer] submitQuestion ignored: no matching answerable head for session=${e}`)}function ae(e){a=e}function O(){let e=g();return e?e.kind===`permission`?{kind:`permission`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,suggestions:e.suggestions,createdAt:e.createdAt}:{kind:`question`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,questions:e.questions,answerable:e.answerable,createdAt:e.createdAt}:null}function k(){return new Promise(e=>{let r=er,i=null;function a(){if(r>tr){j.error(`Agent server: all ports ${er}-${tr} occupied`),e(null);return}i=h.createServer(D),i.on(`error`,t=>{t.code===`EADDRINUSE`?(r++,a()):(j.error(`Agent server error:`,t.message),e(null))}),i.listen(r,`127.0.0.1`,()=>{n=r,t=i;try{let e=ir();m.mkdirSync(e,{recursive:!0}),m.writeFileSync(f.join(e,`runtime.json`),JSON.stringify({port:r,pid:process.pid}),`utf8`)}catch{}j.info(`Agent server listening on 127.0.0.1:${r}`),e(r)})}a()})}function oe(){for(let e of r)e.kind===`permission`&&e.reject(`stopped`);r=[],clearTimeout(i),i=null,a&&a(null),t&&=(t.close(),null),n=null}function se(){return n}return{start:k,stop:oe,getPort:se,getSafeCurrentCard:O,resolvePendingPermission:ne,dismissQuestion:re,submitQuestion:ie,setOnCardChange:ae}}M();var or=f.join(p.homedir(),`.claude`,`settings.json`),sr=300*1e3,cr=3,lr=[`SessionStart`,`SessionEnd`,`UserPromptSubmit`,`PreToolUse`,`PostToolUse`,`PostToolUseFailure`,`Stop`,`StopFailure`,`ApiError`,`Notification`,`PermissionRequest`];function ur(e){let t=null,n=0,r=!1;function i(){try{if(require(`electron`)?.app?.isPackaged)return f.join(process.resourcesPath,`clawd-hook.js`)}catch{}return f.join(__dirname,`clawd-hook.js`)}function a(){try{let{execSync:e}=require(`child_process`),t=e(`where node`,{encoding:`utf8`}).trim().split(`
`)[0];if(t)return t}catch{}return process.execPath.replace(`electron.exe`,`node.exe`)}function o(){try{let e=m.readFileSync(or,`utf8`);return JSON.parse(e)}catch{return null}}function s(e){try{return m.writeFileSync(or,JSON.stringify(e,null,2),`utf8`),!0}catch(e){return j.error(`Failed to write Claude settings:`,e.message),!1}}function c(e,t){return{command:`& "${a()}" "${t}" ${e}`,shell:`powershell`}}function l(e){let t=e.hooks;return!t||!Array.isArray(t)?!1:t.some(e=>e.name&&e.events&&Array.isArray(e.events))}function u(e){return l(e)?(e.hooks=(e.hooks||[]).filter(e=>!e.name?.startsWith(`erzhi-recording`)),!0):!1}function d(){let t=o();if(!t)return{added:!1,updated:!1};let n=i(),r=t.hooks||{};if(u(t),e(),lr.every(e=>(r[e]||[]).some(t=>t.hooks?.some(t=>e===`PermissionRequest`?t.type===`http`&&t.url?.includes(`/permission`):t.type===`command`&&t.command?.startsWith(`&`)&&t.command?.includes(`clawd-hook.js`)&&t.shell===`powershell`))))return{added:!1,updated:!1};for(let t of lr){let i;if(t===`PermissionRequest`)i={type:`http`,url:`http://127.0.0.1:${e()||6e4}/permission`,timeout:600};else{let{command:e,shell:r}=c(t,n);i={type:`command`,command:e,shell:r,async:!0,timeout:5}}r[t]=[{matcher:``,hooks:[i]}]}return t.hooks=r,s(t),{added:!0,updated:!1}}function p(){let e=o();if(!e)return{removed:!1};let t=!1;if(l(e)){let n=e.hooks.length;e.hooks=e.hooks.filter(e=>!e.name?.startsWith(`erzhi-recording`)),e.hooks.length<n&&(t=!0)}let n=e.hooks||{};for(let e of lr)if(n[e]){let r=n[e].length;n[e]=n[e].filter(e=>!e.hooks?.some(e=>e.command?.includes(`clawd-hook.js`))),n[e].length===0?delete n[e]:n[e].length<r&&(t=!0)}return e.hooks=n,s(e),{removed:t}}function h(){let e=o();return e?((e.hooks||{})[lr[0]]||[]).some(e=>e.hooks?.some(e=>e.command?.includes(`clawd-hook.js`))):!1}function g(){let e=[];if(!o())return e.push(`Claude settings file not found`),{healthy:!1,issues:e};if(!h())return e.push(`Hook entry missing`),{healthy:!1,issues:e};let t=i();return m.existsSync(t)?{healthy:e.length===0,issues:e}:(e.push(`Hook script file missing`),{healthy:!1,issues:e})}function _(){if(r)return!1;if(n>=cr)return r=!0,!1;let e=d();return(e.added||e.updated)&&g().healthy?(n=0,!0):(n++,!1)}function v(){let e=g();e.healthy?(n>0&&(n=0),r&&=!1):(j.warn(`Claude hook health check failed:`,e.issues.join(`, `)),_())}function y(){t||(v(),t=setInterval(v,sr),j.info(`Claude hook watcher started`))}function b(){t&&=(clearInterval(t),null)}function x(){let e=g();return{installed:h(),scriptExists:m.existsSync(i()),claudeExists:o()!==null,healthy:e.healthy,repairFailures:n,manualFixRequired:r}}return{install:d,uninstall:p,isInstalled:h,startWatcher:y,stopWatcher:b,getStatus:x,checkHealth:g,repair:_}}M();function dr(e={}){let t=Zn(),n=ar(t),r=ur(()=>n.getPort()),i=null,a=null,o=!1;t.subscribe((e,t)=>{i&&i(e,t)}),n.setOnCardChange(e=>{if(o&&e&&e.kind===`permission`){j.info(`[AgentBridge] auto-allow permission: tool=${e.toolName}`),n.resolvePendingPermission(`allow`);return}a&&a(e)});async function s(){if(t.start(),await n.start()!==null){if(e.autoInstallHooks!==!1){let e=r.install();e.added&&j.info(`Claude Code hooks installed`),e.updated&&j.info(`Claude Code hooks updated`)}e.autoStartWatcher!==!1&&r.isInstalled()&&r.startWatcher()}}function c(){r.stopWatcher(),t.stop(),n.stop()}function l(){return n}function u(){return t}function d(){return r}function f(e){i=e}function p(e){a=e}function m(e){n.resolvePendingPermission(e)}function h(){n.dismissQuestion()}function g(e,t){n.submitQuestion(e,t)}function _(){r.install()}function v(){r.uninstall()}function y(e){o=e,j.info(`[AgentBridge] autoAllow=${e}`)}function b(){return o}let x=null,S=0;function C(){let e=Date.now();if(x!==null&&e-S<3e4)return x;try{let{execSync:e}=require(`child_process`);x=e(`tasklist /NH /FI "IMAGENAME eq claude.exe"`,{encoding:`utf8`,timeout:2e3}).includes(`claude.exe`)}catch{x=!1}return S=e,x}function ee(){let e=t.getSessions(),i=e.length,a=t.getCurrentState(),o=e.map(e=>e.sessionId).join(`,`);j.info(`[AgentBridge] getStatus: real_count=${i}, ids=[${o}], display=${a}`);let s=t.getSessions().length;return{serverRunning:n.getPort()!==null,port:n.getPort(),hookInstalled:r.isInstalled(),hookManagerStatus:r.getStatus(),displayState:a,currentCard:n.getSafeCurrentCard(),sessionCount:s,claudeRunning:C()}}return{start:s,stop:c,getServer:l,getStateMachine:u,getHookManager:d,getStatus:ee,setStateListener:f,setCardListener:p,resolvePermission:m,dismissQuestion:h,submitQuestion:g,installHooks:_,uninstallHooks:v,setAutoAllow:y,getAutoAllow:b}}var fr=`local-video`;function pr(){d.protocol.registerSchemesAsPrivileged([{scheme:fr,privileges:{standard:!0,secure:!0,supportFetchAPI:!0,stream:!0}}])}function mr(){d.protocol.handle(fr,e=>{let t=new URL(e.url),n=decodeURIComponent(t.pathname).replace(/^\//,``),r=e.headers.get(`range`),i=0;try{i=(0,g.statSync)(n).size}catch{return new Response(`File not found: `+n,{status:404})}let a=(0,u.extname)(n).toLowerCase(),o=a===`.mp4`?`video/mp4`:a===`.webm`?`video/webm`:`application/octet-stream`;if(r){let e=/bytes=(\d*)-(\d*)/.exec(r),t=e&&e[1]?parseInt(e[1],10):0,a=e&&e[2]?parseInt(e[2],10):i-1,s=Math.min(a,i-1),c=(0,g.createReadStream)(n,{start:t,end:s});return new Response(C.Readable.toWeb(c),{status:206,headers:{"Content-Range":`bytes ${t}-${s}/${i}`,"Accept-Ranges":`bytes`,"Content-Length":String(s-t+1),"Content-Type":o}})}let s=(0,g.createReadStream)(n);return new Response(C.Readable.toWeb(s),{status:200,headers:{"Content-Length":String(i),"Content-Type":o,"Accept-Ranges":`bytes`}})})}function hr(e,t){let n=new Date(t).toISOString();return e.filter(e=>!!e.reminder&&!e.reminderFired&&!(e.type===`todo`&&e.done)&&e.reminder<=n)}M();var gr=3e4,_r=null;function vr(){let e=hr(U(),Date.now());if(e.length!==0){for(let t of e){let e=yn(t.content).trim();mn(t.type===`memo`&&yn(t.title).trim()?yn(t.title).trim():e.slice(0,24),e.slice(0,90)),Jt(t.id)}cn()||tn(!0)}}function yr(){_r||(vr(),_r=setInterval(vr,gr),j.info(`Todo reminder scheduler started`))}function br(){_r&&=(clearInterval(_r),null),j.info(`Todo reminder scheduler stopped`)}M(),pr();var Z=null,Q=null,$=null,xr=null,Sr=null,Cr=process.env.VITE_DEV_SERVER_URL;function wr(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e)}function Tr(e){Z=new d.BrowserWindow({icon:wr(),width:550,height:420,minWidth:420,minHeight:340,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`二支录制`,backgroundColor:`#eaeaec`,webPreferences:{preload:e,contextIsolation:!0,nodeIntegration:!1,sandbox:!1,backgroundThrottling:!1}}),Cr?Z.loadURL(Cr):Z.loadFile((0,u.join)(process.env.DIST,`index.html`)),Z.on(`close`,e=>{d.app.isQuitting||(e.preventDefault(),Z?.hide())})}d.app.on(`gpu-process-crashed`,(e,t)=>{j.error(`GPU process crashed:`,JSON.stringify(t))}),d.app.whenReady().then(()=>{process.env.DIST=(0,u.join)(__dirname,`../../dist`),process.env.VITE_PUBLIC=d.app.isPackaged?process.env.DIST:(0,u.join)(__dirname,`../../public`),mr(),ye(),j.info(`App starting...`),Ce(j),Ae(j);let e=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);try{d.session.defaultSession.clearCache()}catch(e){j.warn(`clearCache() failed:`,e)}xr=dr({autoInstallHooks:!0,autoStartWatcher:!0}),xr.start().catch(e=>{j.error(`Agent bridge start failed:`,e?.message??e)}),jn(xr),Tr(e),(0,Ve.setMainWindow)(Z),(0,gt.createTray)(),Pn(Z),rt(),Wn(),rn(),yr(),W(),Y();try{let e=et();d.app.setLoginItemSettings({openAtLogin:e.openAtLogin})}catch(e){j.error(`Sync openAtLogin on startup failed:`,e)}d.ipcMain.handle(`show-ai-window`,()=>{Er()}),d.ipcMain.handle(`show-settings-window`,()=>{Dr()}),d.ipcMain.handle(`show-main-window`,()=>{Z&&!Z.isDestroyed()&&(Z.show(),Z.focus())}),process.on(`clawd-show-record-window`,()=>{Z&&!Z.isDestroyed()&&(Z.show(),Z.focus())}),process.on(`clawd-show-ai-window`,()=>{Er()}),process.on(`clawd-show-settings-window`,()=>{Dr()}),process.on(`clawd-show-todo-window`,()=>{on()}),Sr=setInterval(Gn,3e4),d.app.on(`activate`,()=>{d.BrowserWindow.getAllWindows().length===0&&Tr(e)})}),d.app.on(`window-all-closed`,()=>{}),d.app.on(`before-quit`,()=>{d.app.isQuitting=!0;for(let e of d.BrowserWindow.getAllWindows())if(!e.isDestroyed())try{e.webContents.send(`app-before-quit`)}catch{}(0,Ve.hideRegionBorder)(),(0,Ve.hideFloatingIsland)(),(0,Ve.hideCameraPreview)(),ct(),xr?.stop(),jt(),we(),br(),sn(),_n(),On(),Fn(),(0,gt.destroyTray)(),Sr&&=(clearInterval(Sr),null),Z=null,Q=null,$=null});function Er(){if(Q&&!Q.isDestroyed()){Q.show(),Q.focus();return}let e=process.env.VITE_DEV_SERVER_URL,t=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);Q=new d.BrowserWindow({icon:wr(),width:480,height:540,minWidth:400,minHeight:400,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`AI 助手`,backgroundColor:`#eaeaec`,webPreferences:{preload:t,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),e?Q.loadURL(`${e}#/ai?t=${Date.now()}`):Q.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/ai`}),Q.once(`ready-to-show`,()=>{Q?.show()}),Q.on(`closed`,()=>{Q=null})}function Dr(){if($&&!$.isDestroyed()){$.show(),$.focus();return}let e=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);$=new d.BrowserWindow({icon:wr(),width:420,height:480,minWidth:380,minHeight:420,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`设置`,backgroundColor:`#eaeaec`,webPreferences:{preload:e,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),Cr?$.loadURL(`${Cr}#/settings?t=${Date.now()}`):$.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/settings`}),$.once(`ready-to-show`,()=>{$?.show()}),$.on(`closed`,()=>{$=null})}