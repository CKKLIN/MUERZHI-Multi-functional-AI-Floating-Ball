...
<\/script>
</body></html>`;D.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(i)}`),N.info(`Floating island shown`),y=r,e?.cameraEnabled&&T(r,e.cameraDeviceId)}function re(){O&&=(clearInterval(O),null),k&&=(clearTimeout(k),null),D&&!D.isDestroyed()&&(D.close(),D=null),E(),y=null,te=null}function A(e,t){if(ee=e===`idle`?`idle`:e===`recording`?`recording`:e===`paused`?`paused`:ee,e===`show`||e===`hide`){D&&!D.isDestroyed()&&D.webContents.send(`island-state`,e);return}D&&!D.isDestroyed()&&D.webContents.send(`island-state`,e,t),O&&=(clearInterval(O),null),k&&=(clearTimeout(k),null),e===`recording`&&(O=setInterval(()=>{if(!D||D.isDestroyed())return;let e=d.screen.getCursorScreenPoint(),[t,n]=D.getPosition(),[r,i]=D.getSize();e.x>=t&&e.x<=t+r&&e.y>=n-4&&e.y<=n+i?(k&&=(clearTimeout(k),null),D.webContents.send(`island-state`,`show`)):k||=setTimeout(()=>{D&&!D.isDestroyed()&&D.webContents.send(`island-state`,`hide`),k=null},500)},500))}var j=44,M=3;function ie(e,t){se();let n=M,r=n+2,i=d.screen.getPrimaryDisplay().bounds,a=e.y-i.y,o=i.y+i.height-(e.y+e.height),s=j+4,c,u,g,_;a>=s?(_=`top`,c=e.x-r,u=e.y-j-r,g=e.width+r*2):o>=s?(_=`bottom`,c=e.x-r,u=e.y+e.height+r,g=e.width+r*2):(_=`inside`,c=e.x,u=e.y,g=Math.min(e.width,500)),p={...e},m=_,f=new d.BrowserWindow({x:c,y:u,width:g,height:j,frame:!1,transparent:!0,resizable:!1,movable:!1,alwaysOnTop:!0,skipTaskbar:!0,hasShadow:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),f.setVisibleOnAllWorkspaces(!0),f.setAlwaysOnTop(!0,`screen-saver`);let v=`<!DOCTYPE html>
<html><head><style>
*{margin:0;padding:0;box-sizing:border-box}
...
</body></html>`;l.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(w)}`),N.info(`Region border+toolbar shown (split windows):`,e),y=e,t?.cameraEnabled&&T(e,t.cameraDeviceId),l&&!l.isDestroyed()&&l.setAlwaysOnTop(!0,`screen-saver`),f&&!f.isDestroyed()&&f.setAlwaysOnTop(!0,`screen-saver`),h&&!h.isDestroyed()&&h.setAlwaysOnTop(!0,`screen-saver`)}function ae(e,t){f&&!f.isDestroyed()&&(f.webContents.send(`toolbar-state`,e,t,m),(e===`recording`||e===`paused`)&&m===`inside`&&p&&f.setBounds({x:p.x+8,y:p.y+8,width:170,height:40}))}function oe(){l&&!l.isDestroyed()&&(l.close(),l=null)}function se(){oe(),f&&!f.isDestroyed()&&(f.close(),f=null),E(),y=null,N.info(`Region border hidden`)}function ce(){d.ipcMain.on(`region-selected`,(e,t)=>{N.info(`Region selected:`,t),c(t)}),d.ipcMain.on(`region-cancelled`,()=>{N.info(`Region selection cancelled`),c(null)}),d.ipcMain.handle(`show-region-border`,(e,t,n)=>{ie(t,n)}),d.ipcMain.handle(`hide-region-border`,()=>{se()}),d.ipcMain.handle(`hide-border-only`,()=>{oe()}),d.ipcMain.handle(`update-toolbar-state`,(e,t,n)=>{ae(t,n)}),d.ipcMain.on(`toolbar-action`,(e,t)=>{if(N.info(`Toolbar action:`,t),t===`close`){n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,`close`),se();return}n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,t)}),d.ipcMain.removeHandler(`set-mouse-ignore`),d.ipcMain.removeAllListeners(`set-mouse-ignore`),d.ipcMain.handle(`show-floating-island`,(e,t,n)=>{ne(t,n)}),d.ipcMain.handle(`hide-floating-island`,()=>{re()}),d.ipcMain.handle(`hide-camera-preview`,()=>{E()}),d.ipcMain.handle(`toggle-camera-preview`,(e,t,n)=>{t&&y?T(y,n):E()}),d.ipcMain.on(`camera-drag-start`,()=>C()),d.ipcMain.on(`camera-drag-end`,()=>w()),d.ipcMain.handle(`set-island-state`,(e,t,n)=>{A(t,n)}),d.ipcMain.on(`island-action`,(e,t)=>{N.info(`Island action:`,t),n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,t)}),d.ipcMain.on(`resize-island`,(e,t,n)=>{if(D&&!D.isDestroyed()){if(!Number.isFinite(t))return;let e=te||d.screen.getPrimaryDisplay().bounds,r=t+20,i=Math.round(e.x+(e.width-r)/2),a=Number.isFinite(n)?n:44;D.setBounds({x:i,y:e.y+4,width:r,height:a})}})}t.exports={selectRegion:s,showRegionBorder:ie,hideRegionBorder:se,hideBorderOnly:oe,updateToolbarState:ae,updateAudioLevels:i,showFloatingIsland:ne,hideFloatingIsland:re,showCameraPreview:T,hideCameraPreview:E,setFloatingIslandState:A,setMainWindow:r,registerRegionSelectorHandlers:ce}})),L=Re();P();var R=null,z=null,B=null,V=66,H=240,ze=`floating-ball-pos.json`;function Be(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),ze)}function Ve(){try{let e=g.default.readFileSync(Be(),`utf-8`),t=JSON.parse(e);if(typeof t.x==`number`&&typeof t.y==`number`)return t}catch{}return null}function He(e){try{g.default.writeFileSync(Be(),JSON.stringify(e),`utf-8`)}catch{}}var Ue=`floating-ball-settings.json`,We={visible:!0,alwaysOnTop:!0,openAtLogin:!1},Ge=null;function Ke(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),Ue)}function qe(){try{let e=g.default.readFileSync(Ke(),`utf-8`),t=JSON.parse(e);return{visible:typeof t.visible==`boolean`?t.visible:We.visible,alwaysOnTop:typeof t.alwaysOnTop==`boolean`?t.alwaysOnTop:We.alwaysOnTop,openAtLogin:typeof t.openAtLogin==`boolean`?t.openAtLogin:We.openAtLogin}}catch{}return{...We}}function Je(e){try{g.default.writeFileSync(Ke(),JSON.stringify(e),`utf-8`)}catch{}}function U(){return Ge||(Ge=qe(),Ge)}function Ye(e){let t={...U(),...e};return Je(t),Ge=t,t}function Xe(){z=null;try{g.default.unlinkSync(Be())}catch{}}function Ze(){U().visible&&tt()}function Qe(e){R&&!R.isDestroyed()&&R.setAlwaysOnTop(e,`screen-saver`)}function $e(e,t,n){!R||R.isDestroyed()||R.webContents.executeJavaScript(`if(window.updateBadge) updateBadge(${Number(e)||0}, ${!!t}, ${!!n})`).catch(()=>{})}function et(e){e.visible?tt():nt(),Qe(e.alwaysOnTop)}function tt(){if(R&&!R.isDestroyed()){R.show(),R.focus();return}if(!z){let e=Ve();if(e)z=e;else{let e=d.screen.getPrimaryDisplay().bounds;z={x:Math.round(e.x+(e.width-V)/2),y:Math.round(e.y+(e.height-V)/2)}}}R=new d.BrowserWindow({x:z.x,y:z.y,width:V,height:V,frame:!1,transparent:!0,backgroundColor:`#00000000`,resizable:!1,alwaysOnTop:U().alwaysOnTop,skipTaskbar:!0,hasShadow:!1,show:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),R.setVisibleOnAllWorkspaces(!0),R.setAlwaysOnTop(U().alwaysOnTop,`screen-saver`);let e=lt();R.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(e)}`),R.once(`ready-to-show`,()=>{R?.show(),R&&!R.isDestroyed()&&R.webContents.executeJavaScript(`ensureMenu()`).catch(()=>{})});let t=R;R.on(`closed`,()=>{R===t&&(R=null)}),R.on(`move`,()=>{if(!R||R.isDestroyed())return;let[e,t]=R.getPosition(),[n,r]=R.getSize();z={x:Math.round(e+n/2-V/2),y:Math.round(t+r/2-V/2)}}),R.on(`close`,()=>{z&&He(z)}),R.on(`blur`,()=>{rt&&at()}),N.info(`Floating ball shown`)}function nt(){if(R&&!R.isDestroyed()){let[e,t]=R.getPosition(),[n,r]=R.getSize();z={x:Math.round(e+n/2-V/2),y:Math.round(t+r/2-V/2)},He(z);let i=R;R=null,i.destroy(),N.info(`Floating ball hidden`)}}var rt=!1,W=null;async function it(){if(!R||R.isDestroyed())return;W&&=(clearTimeout(W),null);let[e,t]=R.getPosition(),n=z?z.x:e,r=z?z.y:t,i=Math.round(n+V/2),a=Math.round(r+V/2);N.info(`[Ball] expand at`,[e,t],`center`,[i,a]);let[o]=R.getSize(),s=o!==H;s&&(R.setOpacity(0),R.setBounds({x:i-H/2,y:a-H/2,width:H,height:H}));try{await R.webContents.executeJavaScript(`restartBloom(); void 0;`)}catch{}if(!(!R||R.isDestroyed())){if(s){try{await R.capturePage()}catch{}if(!R||R.isDestroyed())return;R.setOpacity(1)}rt=!0,R.webContents.send(`ball-state`,`expanded`)}}async function at(){if(rt=!1,!R||R.isDestroyed())return;if(!z){let[e,t]=R.getPosition();z={x:Math.round(e+H/2-V/2),y:Math.round(t+H/2-V/2)}}let e=z.x,t=z.y;N.info(`[Ball] collapse at`,[e,t]);try{await R.webContents.executeJavaScript(`document.body.classList.remove('expanded'); isExpanded=false; void 0;`)}catch{}!R||R.isDestroyed()||(W&&clearTimeout(W),W=setTimeout(()=>{if(W=null,!(!R||R.isDestroyed())&&!rt){try{R.webContents.executeJavaScript(`var s=document.getElementById('ringSvg');while(s.firstChild){s.removeChild(s.firstChild)} menuCreated=false; void 0;`)}catch{}!R||R.isDestroyed()||(R.setOpacity(0),R.setBounds({x:e,y:t,width:V,height:V}),R.setOpacity(1))}},920))}function ot(e){if(e===`record`)process.emit(`clawd-show-record-window`);else if(e===`ai`)process.emit(`clawd-show-ai-window`);else if(e===`todo`)process.emit(`clawd-show-todo-window`);else if(e===`settings`)process.emit(`clawd-show-settings-window`);else{let t=d.BrowserWindow.getAllWindows().find(e=>!e.isDestroyed()&&e!==R);t&&!t.isDestroyed()&&t.webContents.send(`on-floating-ball-action`,e)}at()}var st=null;function ct(e=48){if(st)return st;try{let t=[(0,u.join)(__dirname,`..`,`..`,`public`,`logo.png`),(0,u.join)(__dirname,`..`,`public`,`logo.png`),(0,u.join)(__dirname,`..`,`..`,`resources`,`logo.png`)];for(let n of t)if(g.default.existsSync(n))return st=d.nativeImage.createFromPath(n).resize({width:e,height:e,quality:`good`}).toDataURL(),st}catch{}return``}function lt(){return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<style>
...
<div id="ball">
  ...
  <div class="core">
    <button id="trigger">
      <img id="logoImg" class="logo-img" src="${ct(48)}" alt="logo" />
    </button>
...
</html>`}function ut(){d.ipcMain.handle(`show-floating-ball`,()=>{tt()}),d.ipcMain.handle(`hide-floating-ball`,()=>{nt()}),d.ipcMain.handle(`toggle-floating-ball`,()=>{nt()}),d.ipcMain.on(`floating-ball-expand`,()=>{it()}),d.ipcMain.on(`floating-ball-collapse`,()=>{at()}),d.ipcMain.on(`floating-ball-action`,(e,t)=>{N.info(`Floating ball action:`,t),ot(t)});let e=null;d.ipcMain.on(`floating-ball-drag-start`,(t,n,r)=>{if(!R||R.isDestroyed())return;let[i,a]=R.getPosition(),[o,s]=R.getSize();B={winX:i,winY:a,scrX:n,scrY:r},e={w:o,h:s}}),d.ipcMain.on(`floating-ball-move`,(t,n,r)=>{if(!R||R.isDestroyed()||!B||!e||!Number.isFinite(n)||!Number.isFinite(r))return;let i=n-B.scrX,a=r-B.scrY,o=Math.round(B.winX+i),s=Math.round(B.winY+a);R.setBounds({x:o,y:s,width:e.w,height:e.h});let[c,l]=R.getPosition();(c!==o||l!==s)&&R.setBounds({x:o+(o-c),y:s+(s-l),width:e.w,height:e.h})}),d.ipcMain.on(`floating-ball-drag-end`,()=>{if(B=null,e=null,R&&!R.isDestroyed()){let[e,t]=R.getPosition(),[n,r]=R.getSize(),i=d.screen.getDisplayMatching(R.getBounds()).bounds,a=e,o=t;if(e-i.x<40?a=i.x:i.x+i.width-(e+n)<40&&(a=i.x+i.width-n),t-i.y<40?o=i.y:i.y+i.height-(t+r)<40&&(o=i.y+i.height-r),a!==e||o!==t){R.setBounds({x:a,y:o,width:n,height:r});let[e,t]=R.getPosition();R.setBounds({x:a+(a-e),y:o+(o-t),width:n,height:r}),z&&(z={x:a,y:o},He(z)),N.info(`Floating ball snapped to edge:`,[a,o])}}z&&He(z)}),d.ipcMain.handle(`get-floating-ball-settings`,()=>U()),d.ipcMain.handle(`set-floating-ball-settings`,(e,t)=>{let n=Ye(t);if(et(n),t.openAtLogin!==void 0)try{d.app.setLoginItemSettings({openAtLogin:t.openAtLogin})}catch(e){N.error(`setLoginItemSettings failed:`,e)}return n}),d.ipcMain.handle(`reset-floating-ball-position`,()=>{if(Xe(),R&&!R.isDestroyed()){let e=d.screen.getPrimaryDisplay().bounds,t=Math.round(e.x+(e.width-V)/2),n=Math.round(e.y+(e.height-V)/2);rt=!1;try{R.webContents.executeJavaScript(`document.body.classList.remove('expanded'); var s=document.getElementById('ringSvg');if(s){while(s.firstChild){s.removeChild(s.firstChild)}} menuCreated=false; isExpanded=false; void 0;`).catch(()=>{})}catch{}R.setBounds({x:t,y:n,width:V,height:V}),z={x:t,y:n};let[r,i]=R.getPosition();(r!==t||i!==n)&&R.setBounds({x:t+(t-r),y:n+(n-i),width:V,height:V})}})}var dt=s(((e,t)=>{P();var n=null;function r(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e).resize({width:16,height:16})}function i(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.png`):(0,u.join)(__dirname,`../../public/logo.png`);return e?d.nativeImage.createFromPath(e).resize({width:64,height:64,quality:`better`}):d.nativeImage.createEmpty()}function a(){if(n&&!n.isDestroyed())return;n=new d.Tray(r()),n.setToolTip(`二支录制`);let e=d.Menu.buildFromTemplate([{label:`显示设置窗口`,click:()=>{process.emit(`clawd-show-settings-window`)}},{type:`separator`},{label:`退出`,click:()=>{let{app:e}=require(`electron`);e.quit()}}]);n.setContextMenu(e),n.on(`click`,()=>{process.emit(`clawd-show-settings-window`)}),N.info(`System tray created`)}function o(e,t){n&&!n.isDestroyed()&&(n.displayBalloon({title:e,content:t,icon:i()}),N.info(`Tray balloon:`,e,t))}function s(){n&&!n.isDestroyed()&&(n.destroy(),n=null)}t.exports={createTray:a,showBalloon:o,destroyTray:s}}))();P();var G=null,K=null,ft=!1,pt=!1,mt=`ai-island-settings.json`,ht={flat:!1},gt=null;function _t(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),mt)}function vt(){try{let e=g.default.readFileSync(_t(),`utf-8`),t=JSON.parse(e);return{flat:typeof t.flat==`boolean`?t.flat:ht.flat}}catch{}return{...ht}}function yt(e){try{g.default.writeFileSync(_t(),JSON.stringify(e),`utf-8`)}catch{}}function bt(e){G&&!G.isDestroyed()&&G.webContents.send(`ai-island-set-flat`,e.flat)}function xt(){return gt||(gt=vt(),gt)}function St(e){let t={...xt()};return typeof e.flat==`boolean`&&(t.flat=e.flat),yt(t),gt=t,bt(t),t}function Ct(){return d.app.isPackaged?f.join(process.resourcesPath,`question-card-utils.js`):f.join(__dirname,`question-card-utils.js`)}function wt(){return`<!DOCTYPE html>
<html><head><style>
*{margin:0;padding:0;box-sizing:border-box}
html,body{height:100%;overflow:hidden;font-family:'Segoe UI',system-ui,sans-serif}
.island{
...
</style></head><body${xt().flat?` class="flat"`:``}>
<div class="island" id="island">
...
initStatus()
<\/script>
</body></html>`}function Tt(){if(G&&!G.isDestroyed())return;let e=d.screen.getPrimaryDisplay().bounds;G=new d.BrowserWindow({x:Math.round(e.x+(e.width-200)/2),y:e.y+4,width:200,height:44,frame:!1,transparent:!0,resizable:!1,movable:!1,alwaysOnTop:!0,skipTaskbar:!0,hasShadow:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),G.setVisibleOnAllWorkspaces(!0),G.setMinimumSize(100,12),G.setAlwaysOnTop(!0,`screen-saver`),G.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(wt())}`),N.info(`AI island shown`)}function Et(){G&&!G.isDestroyed()&&(G.close(),G=null,N.info(`AI island hidden`))}function Dt(){d.ipcMain.handle(`get-ai-island-settings`,()=>xt()),d.ipcMain.handle(`set-ai-island-settings`,(e,t)=>St(t)),d.ipcMain.on(`resize-ai-island`,(e,t,n)=>{if(!G||G.isDestroyed()||!Number.isFinite(t))return;let r=t+20,i=Number.isFinite(n)?n:44;if(!(!Number.isFinite(r)||!Number.isFinite(i)))if(xt().flat){let e=d.screen.getDisplayMatching(G.getBounds()).bounds,n=Math.round(e.x+(e.width-t)/2);if(!Number.isFinite(n))return;G.setBounds({x:n,y:e.y,width:t,height:i})}else if(ft){let[e,t]=G.getPosition();if(!Number.isFinite(e)||!Number.isFinite(t))return;G.setBounds({x:e,y:t,width:r,height:i})}else{let e=d.screen.getPrimaryDisplay().bounds,t=Math.round(e.x+(e.width-r)/2),n=e.y+4;if(!Number.isFinite(t)||!Number.isFinite(n))return;G.setBounds({x:t,y:n,width:r,height:i})}}),d.ipcMain.on(`ai-island-drag-start`,(e,t,n)=>{if(!G||G.isDestroyed()||!Number.isFinite(t)||!Number.isFinite(n))return;let[r,i]=G.getPosition();K={winX:r,winY:i,scrX:t,scrY:n}}),d.ipcMain.on(`ai-island-drag-move`,(e,t,n)=>{if(!G||G.isDestroyed()||!K||!Number.isFinite(t)||!Number.isFinite(K.scrX)||!Number.isFinite(K.winX)||!Number.isFinite(K.winY))return;let r=t-K.scrX,i=Math.round(K.winX+r);if(!Number.isFinite(i))return;let[a,o]=G.getSize();G.setBounds({x:i,y:K.winY,width:a,height:o})}),d.ipcMain.on(`ai-island-drag-end`,()=>{K=null,xt().flat||(ft=!0)}),d.ipcMain.on(`set-ai-island-mouse-mode`,(e,t)=>{if(!G||G.isDestroyed())return;let n=!t;n!==pt&&(pt=n,G.setIgnoreMouseEvents(n,{forward:!0}))})}var Ot={info:()=>{},warn:()=>{},error:()=>{}},kt=null,At=`todo-notes.json`,jt=`todo-settings.json`;function Mt(){if(kt)return kt;let{app:e}=require(`electron`);return e.getPath(`userData`)}function Nt(){return(0,u.join)(Mt(),At)}function Pt(){return(0,u.join)(Mt(),jt)}function Ft(){try{let e=g.readFileSync(Nt(),`utf-8`),t=JSON.parse(e);if(Array.isArray(t.items))return{items:t.items.filter(e=>e&&typeof e.id==`string`),meta:{schemaVersion:t.meta?.schemaVersion??1}}}catch{}return{items:[],meta:{schemaVersion:1}}}function q(){return Ft().items}function It(e){let t=Nt(),n=t+`.tmp`;try{g.writeFileSync(n,JSON.stringify(e,null,2),`utf-8`),g.renameSync(n,t)}catch{try{g.writeFileSync(t,JSON.stringify(e,null,2),`utf-8`)}catch(e){Ot.error(`todo store save failed:`,e?.message??e)}}}function Lt(e){It({items:e,meta:{schemaVersion:1}})}function Rt(e){let t=q(),n=Date.now(),r={id:(0,b.randomUUID)(),type:e.type,title:e.title??``,content:e.content??``,priority:e.priority??`medium`,reminder:e.reminder??null,reminderFired:!1,done:e.done??!1,createdAt:n,updatedAt:n};return t.unshift(r),Lt(t),t}function zt(e,t){let n=q(),r=n.find(t=>t.id===e);return r?(Object.assign(r,t,{updatedAt:Date.now()}),Lt(n),n):n}function Bt(e,t){let n=q(),r=n.find(t=>t.id===e);return r?(t.reminder!==void 0&&t.reminder!==r.reminder&&(r.reminderFired=!1),Object.assign(r,t,{updatedAt:Date.now()}),Lt(n),n):n}function Vt(e){let t=q().filter(t=>t.id!==e);return Lt(t),t}function Ht(e){let t=q(),n=t.find(t=>t.id===e);return n&&n.type===`todo`&&(n.done=!n.done,n.updatedAt=Date.now(),Lt(t)),t}function Ut(e){return zt(e,{reminderFired:!0})}function Wt(e){return e.filter(e=>e.type===`todo`&&!e.done).length}var Gt={badgeVisible:!0,windowAlwaysOnTop:!0};function Kt(){try{let e=JSON.parse(g.readFileSync(Pt(),`utf-8`));return{badgeVisible:typeof e.badgeVisible==`boolean`?e.badgeVisible:Gt.badgeVisible,windowAlwaysOnTop:typeof e.windowAlwaysOnTop==`boolean`?e.windowAlwaysOnTop:Gt.windowAlwaysOnTop}}catch{return{...Gt}}}function qt(e){let t={...Kt(),...e};try{g.writeFileSync(Pt(),JSON.stringify(t,null,2),`utf-8`)}catch(e){Ot.error(`todo settings save failed:`,e?.message??e)}return t}var Jt=!1;function J(){let e=Wt(q()),t=Kt().badgeVisible;$e(e,Jt,t)}function Yt(e){Jt=e,J()}function Xt(){Yt(!1)}function Zt(){d.ipcMain.on(`floating-ball-badge-ready`,()=>{J()})}P();var Y=null;function Qt(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`..`,`..`,`public`,`logo.ico`);return d.nativeImage.createFromPath(e)}function $t(){if(Y&&!Y.isDestroyed()){Y.show(),Y.focus(),Xt();return}let e=process.env.VITE_DEV_SERVER_URL,t=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);Y=new d.BrowserWindow({icon:Qt(),width:360,height:450,minWidth:320,minHeight:360,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`待办便签`,backgroundColor:`#eaeaec`,webPreferences:{preload:t,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),Y.setAlwaysOnTop(Kt().windowAlwaysOnTop,`normal`),e?Y.loadURL(`${e}#/todo?t=${Date.now()}`):Y.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/todo`}),Y.once(`ready-to-show`,()=>{Y?.show()}),Y.on(`closed`,()=>{Y=null}),Xt(),N.info(`Todo window shown`)}function en(){Y&&!Y.isDestroyed()&&Y.close(),Y=null}function tn(){return!!(Y&&!Y.isDestroyed())}function nn(){let e=!Kt().windowAlwaysOnTop;return qt({windowAlwaysOnTop:e}),Y&&!Y.isDestroyed()&&Y.setAlwaysOnTop(e,`normal`),e}P();var{updateAudioLevels:rn}=Re();function an(){return(0,u.join)(d.app.getPath(`userData`),`recordings.json`)}function on(e){(0,L.registerRegionSelectorHandlers)(),ut(),Dt(),d.ipcMain.handle(`show-ai-island`,()=>{Tt()}),d.ipcMain.handle(`hide-ai-island`,()=>{Et()}),d.ipcMain.handle(`select-region`,async()=>(0,L.selectRegion)()),d.ipcMain.handle(`get-sources`,async(e,t)=>(await d.desktopCapturer.getSources({types:t??[`screen`,`window`],thumbnailSize:{width:340,height:200},fetchWindowIcons:!0})).map(e=>({id:e.id,name:e.name,display_id:e.display_id,appIcon:e.appIcon?.toDataURL()||null,thumbnail:e.thumbnail.toDataURL()}))),d.ipcMain.handle(`get-system-audio-sources`,async()=>{try{return(await d.desktopCapturer.getSources({types:[`audio`]})).map(e=>({id:e.id,name:e.name}))}catch{return[]}}),d.ipcMain.handle(`show-save-dialog`,async(e,t)=>{let n=d.BrowserWindow.getFocusedWindow();return n?d.dialog.showSaveDialog(n,{title:t?.title??`Save Recording`,defaultPath:t?.defaultPath??`recording-${Date.now()}.webm`,filters:t?.filters??[{name:`WebM Video`,extensions:[`webm`]},{name:`MP4 Video`,extensions:[`mp4`]},{name:`GIF`,extensions:[`gif`]}]}):{canceled:!0,filePath:null}}),d.ipcMain.handle(`show-open-dialog`,async(e,t)=>{let n=d.BrowserWindow.getFocusedWindow();return n?d.dialog.showOpenDialog(n,{title:t?.title??`Select File`,defaultPath:t?.defaultPath,filters:t?.filters??[{name:`Video Files`,extensions:[`webm`,`mp4`,`gif`]}],properties:t?.properties}):{canceled:!0,filePaths:[]}}),d.ipcMain.handle(`get-default-save-dir`,async()=>d.app.getPath(`videos`)||d.app.getPath(`desktop`)),d.ipcMain.handle(`write-file`,async(e,t,n)=>{try{return await g.default.promises.mkdir((0,u.dirname)(n),{recursive:!0}),await g.default.promises.writeFile(n,t),N.info(`保存文件`,n),{success:!0,filePath:n}}catch(e){return N.error(`保存文件失败`,n,e.message),{success:!1,filePath:n,error:e.message}}}),d.ipcMain.handle(`read-file`,async(e,t)=>{try{return(await g.default.promises.readFile(t)).buffer}catch(e){throw Error(`Failed to read file: ${e.message}`)}}),d.ipcMain.handle(`file-exists`,async(e,t)=>{try{return await g.default.promises.access(t),!0}catch{return!1}}),d.ipcMain.handle(`delete-file`,async(e,t)=>{try{return await g.default.promises.unlink(t),!0}catch{return!1}}),d.ipcMain.handle(`get-file-size`,async(e,t)=>{try{return(await g.default.promises.stat(t)).size}catch{return 0}});function t(e,t,...n){if(!(!e||e.isDestroyed()))try{e.webContents.send(t,...n)}catch{}}d.ipcMain.handle(`convert-to-mp4`,async(e,n,r,i)=>{N.info(`转换为 MP4`,n,`->`,r,i?`crop: ${i.width}x${i.height}`:``);let a=d.BrowserWindow.fromWebContents(e.sender);return Pe(n,r,e=>{t(a,`on-conversion-progress`,e)},i)}),d.ipcMain.handle(`crop-video`,async(e,n,r,i)=>{N.info(`裁剪视频`,n,`->`,r,`crop: ${i.width}x${i.height}+${i.x}+${i.y}`);let a=d.BrowserWindow.fromWebContents(e.sender);return Fe(n,r,i,e=>{t(a,`on-conversion-progress`,e)})}),d.ipcMain.handle(`convert-to-gif`,async(e,n,r,i)=>{N.info(`转换为 GIF`,n,`->`,r);let a=d.BrowserWindow.fromWebContents(e.sender);return Le(n,r,i,e=>{t(a,`on-conversion-progress`,e)})}),d.ipcMain.handle(`merge-multi-screen`,async(e,n,r)=>{N.info(`合并多屏录制`,n.length,`个屏幕 ->`,r);let i=d.BrowserWindow.fromWebContents(e.sender);return Ie(n,r,e=>{t(i,`on-conversion-progress`,e)})}),d.ipcMain.handle(`open-file-location`,async(e,t)=>{d.shell.showItemInFolder(t)}),d.ipcMain.handle(`open-external`,async(e,t)=>{d.shell.openExternal(t)}),d.ipcMain.handle(`open-path`,async(e,t)=>{await d.shell.openPath(t)}),d.ipcMain.handle(`get-app-version`,async()=>d.app.getVersion()),d.ipcMain.handle(`get-screen-scale-factor`,async()=>d.screen.getPrimaryDisplay().scaleFactor),d.ipcMain.handle(`get-screen-bounds`,async()=>{let e=d.screen.getPrimaryDisplay(),t=e.scaleFactor;return{x:Math.round(e.bounds.x/t),y:Math.round(e.bounds.y/t),width:Math.round(e.bounds.width/t),height:Math.round(e.bounds.height/t)}}),d.ipcMain.handle(`take-screenshot`,async e=>{try{let e=await d.desktopCapturer.getSources({types:[`screen`],thumbnailSize:{width:0,height:0}});if(!e.length)throw Error(`未找到屏幕源`);let t=e[0].thumbnail.toPNG(),n=new Date,r=`截图_${n.getFullYear()}${String(n.getMonth()+1).padStart(2,`0`)}${String(n.getDate()).padStart(2,`0`)}_${String(n.getHours()).padStart(2,`0`)}${String(n.getMinutes()).padStart(2,`0`)}${String(n.getSeconds()).padStart(2,`0`)}.png`,i=(0,u.join)(d.app.getPath(`desktop`),r);return await g.default.promises.writeFile(i,t),(0,dt.showBalloon)(`二支录制`,`截图已保存到桌面：${r}`),{success:!0,filePath:i}}catch(e){return N.error(`截图失败`,e.message),{success:!1,error:e.message}}}),d.ipcMain.handle(`get-all-displays`,async()=>{let e=d.screen.getAllDisplays(),t=d.screen.getPrimaryDisplay(),n=await d.desktopCapturer.getSources({types:[`screen`],thumbnailSize:{width:340,height:200}});return e.map((e,r)=>{let i=n[r];return{id:e.id,label:e.id===t.id?`主屏幕`:`屏幕 ${r+1}`,bounds:e.bounds,scaleFactor:e.scaleFactor,size:{width:e.size.width,height:e.size.height},isPrimary:e.id===t.id,sourceId:i?.id||null,sourceName:i?.name||``,thumbnail:i?.thumbnail?.toDataURL()||``}})}),d.ipcMain.handle(`minimize-window`,async e=>{d.BrowserWindow.fromWebContents(e.sender)?.minimize()}),d.ipcMain.handle(`show-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t&&(t.show(),t.focus())}),d.ipcMain.handle(`maximize-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t?.isMaximized()?t.unmaximize():t?.maximize()}),d.ipcMain.handle(`close-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t&&t.hide()}),d.ipcMain.on(`notify-conversion-start`,()=>{(0,dt.showBalloon)(`二支录制`,`录制完成，正在转换视频格式...`)}),d.ipcMain.on(`show-about-window`,()=>{let e=d.BrowserWindow.getFocusedWindow();if(e){let t=new d.BrowserWindow({width:360,height:400,resizable:!1,skipTaskbar:!0,frame:!1,modal:!0,parent:e,backgroundColor:`#eaeaec`,webPreferences:{preload:(0,u.join)(__dirname,`..`,`preload`,`index.cjs`),contextIsolation:!0,nodeIntegration:!1,sandbox:!1}});d.ipcMain.on(`close-about-window`,()=>{t.close(),d.ipcMain.removeAllListeners(`close-about-window`)}),t.on(`closed`,()=>{d.ipcMain.removeAllListeners(`close-about-window`)});let n=process.env.VITE_DEV_SERVER_URL?`${process.env.VITE_DEV_SERVER_URL}about.html`:(0,u.join)(d.app.getAppPath(),`dist`,`about.html`);n.startsWith(`http`)?t.loadURL(n):t.loadFile(n)}}),d.ipcMain.on(`notify-conversion-done`,()=>{(0,dt.showBalloon)(`二支录制`,`视频转换完成！`)}),d.ipcMain.on(`update-audio-levels`,(e,t,n)=>{rn(t,n)}),d.ipcMain.handle(`load-recordings`,async()=>{let e=an();try{let t=await g.default.promises.readFile(e,`utf-8`),n=JSON.parse(t);return N.info(`加载录制历史`,e,n.length,`条`),n}catch(t){return N.info(`加载录制历史失败（可能首次运行）`,e,t.message),[]}}),d.ipcMain.handle(`save-recordings`,async(e,t)=>{let n=an();try{return await g.default.promises.writeFile(n,JSON.stringify(t),`utf-8`),N.info(`保存录制历史`,n,t.length,`条`),!0}catch(e){return N.error(`保存录制历史失败`,n,e.message),!1}}),e&&(e.setStateListener((e,t)=>{(e!==`idle`||t&&t.length>0)&&Tt();let n=d.BrowserWindow.getAllWindows();for(let r of n)if(!r.isDestroyed())try{r.webContents.send(`agent-state-update`,{state:e,sessions:t})}catch{}}),e.setCardListener(e=>{e&&Tt();let t;t=e?e.kind===`permission`?{kind:`permission`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,suggestions:e.suggestions,createdAt:e.createdAt}:{kind:`question`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,questions:e.questions,answerable:e.answerable,createdAt:e.createdAt}:null,N.info(`[IPC] broadcast card: kind=${e?e.kind:`null`}, wins=${d.BrowserWindow.getAllWindows().length}`);let n=d.BrowserWindow.getAllWindows();for(let e of n)if(!e.isDestroyed())try{e.webContents.send(`agent-card-update`,t)}catch(e){N.error(`[IPC] send card to window failed: ${e.message}`)}}),d.ipcMain.handle(`agent-get-status`,()=>{let t=e?.getStatus()??null;return N.info(`[IPC] agentGetStatus: sessionCount=${t?.sessionCount}, displayState=${t?.displayState}, serverRunning=${t?.serverRunning}`),t}),d.ipcMain.handle(`agent-install-hooks`,()=>(e?.installHooks(),e?.getStatus())),d.ipcMain.handle(`agent-uninstall-hooks`,()=>(e?.uninstallHooks(),e?.getStatus())),d.ipcMain.handle(`agent-resolve-permission`,(t,n)=>e?.resolvePermission(n)),d.ipcMain.handle(`agent-dismiss-question`,()=>e?.dismissQuestion()),d.ipcMain.handle(`agent-submit-question`,(t,n,r)=>e?.submitQuestion(n,r)),d.ipcMain.handle(`agent-set-auto-allow`,(t,n)=>e?.setAutoAllow(n)),d.ipcMain.handle(`agent-get-auto-allow`,()=>e?.getAutoAllow()??!1)),sn()}function sn(){d.ipcMain.handle(`todo-get`,()=>q()),d.ipcMain.handle(`todo-create`,(e,t)=>{let n=Rt(t);return J(),n}),d.ipcMain.handle(`todo-update`,(e,t,n)=>{let r=Bt(t,n);return J(),r}),d.ipcMain.handle(`todo-delete`,(e,t)=>{let n=Vt(t);return J(),n}),d.ipcMain.handle(`todo-toggle-done`,(e,t)=>{let n=Ht(t);return J(),n}),d.ipcMain.handle(`todo-show-window`,()=>{$t()}),d.ipcMain.handle(`todo-close-window`,()=>{en()}),d.ipcMain.handle(`todo-window-visible`,()=>tn()),d.ipcMain.handle(`todo-toggle-always-on-top`,()=>nn()),d.ipcMain.handle(`todo-get-settings`,()=>Kt()),d.ipcMain.handle(`todo-set-settings`,(e,t)=>{let n=qt(t);return J(),n})}P();var cn=null;function ln(e){cn=e,d.globalShortcut.register(`CommandOrControl+Shift+R`,()=>{N.info(`Global shortcut: start/stop recording`),cn?.webContents.send(`on-global-shortcut`,`startStop`)}),d.globalShortcut.register(`CommandOrControl+Shift+P`,()=>{N.info(`Global shortcut: pause/resume recording`),cn?.webContents.send(`on-global-shortcut`,`pauseResume`)}),N.info(`Global shortcuts registered`)}function un(){d.globalShortcut.unregisterAll()}P();var dn=`http://8.163.43.7:3000/report-ip`;function X(){return(0,u.join)(d.app.getPath(`userData`),`pending-reports.json`)}function fn(e){let t=[];try{g.default.existsSync(X())&&(t=JSON.parse(g.default.readFileSync(X(),`utf-8`)))}catch{}t.push(e),g.default.writeFileSync(X(),JSON.stringify(t,null,2),`utf-8`),N.info(`Saved offline report to local, total pending:`,t.length)}function pn(){try{if(g.default.existsSync(X()))return JSON.parse(g.default.readFileSync(X(),`utf-8`))}catch{}return[]}function mn(){try{g.default.unlinkSync(X())}catch{}}async function hn(e){try{return await fetch(dn,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),!0}catch{return!1}}async function gn(){let e=pn();if(e.length===0)return!0;let t=[];for(let n of e)await hn(n)?N.info(`Flushed pending report:`,n.公网IP,n.上报时间):t.push(n);return t.length===0?(mn(),N.info(`All pending reports flushed`),!0):(g.default.writeFileSync(X(),JSON.stringify(t,null,2),`utf-8`),!1)}async function _n(){let e=[async()=>{let e=(await fetch(`https://qifu.baidu.com/opus/api/ip/local`,{headers:{Referer:`https://www.baidu.com`}}).then(e=>e.json()))?.data;if(!e?.ip)throw Error(`empty`);return{公网IP:e.ip,国家:e.country||``,省份:e.province||``,城市:e.city||``,区县:e.district||e.area||``,详细地址:[e.country,e.province,e.city,e.district||e.area].filter(Boolean).join(``),运营商:e.isp||``}},async()=>{let e=await fetch(`http://whois.pconline.com.cn/ipJson.jsp`).then(e=>e.arrayBuffer()),t=new TextDecoder(`gbk`).decode(e),n=JSON.parse(t);if(!n.ip)throw Error(`empty`);return{公网IP:n.ip,国家:`中国`,省份:n.pro||``,城市:n.city||``,区县:n.region||``,详细地址:n.addr||``,运营商:n.addr?.split(` `)?.[1]||``}},async()=>{let e=await fetch(`http://ip-api.com/json/?lang=zh-CN`).then(e=>e.json());if(!e.query)throw Error(`empty`);return{公网IP:e.query,国家:e.country,省份:e.regionName,城市:e.city,区县:``,详细地址:`${e.country}${e.regionName}${e.city}`,运营商:e.isp,纬度:String(e.lat??``),经度:String(e.lon??``)}}];for(let t of e)try{return await t()}catch{continue}return{公网IP:``,国家:``,省份:``,城市:``,区县:``,详细地址:``,运营商:``}}function vn(){let e=(0,y.networkInterfaces)();for(let t of Object.keys(e))for(let n of e[t])if(n.family===`IPv4`&&!n.internal)return n.address;return`127.0.0.1`}async function yn(){let e=vn(),t={电脑名:(0,y.hostname)(),局域网IP:e,上报时间:new Date().toISOString()},n;try{n=await _n()}catch{n={公网IP:``,国家:``,省份:``,城市:``,区县:``,详细地址:``,运营商:``}}let r={...t,...n};await hn(r)?(N.info(`IP reported:`,n.公网IP,n.省份,n.城市),gn()):(N.info(`Network unavailable, saving report locally`),fn(r))}function bn(){pn().length>0&&gn()}P();var xn={error:4,notification:3,working:2,thinking:1,idle:0},Sn=600*1e3,Cn=300*1e3,wn=10*1e3,Tn=2e3;function En(){let e=new Map,t=null,n=[],r=null,i=`idle`;function a(e){return n.push(e),()=>{n=n.filter(t=>t!==e)}}function o(){let t=l(),r=Array.from(e.values());t!==i&&(i=t);for(let e of n)e(i,r)}function s(t,n,i,a={}){r&&=(clearTimeout(r),null);let s=e.get(t),c={sessionId:t,agentId:a.agentId||`claude-code`,state:n,event:i,updatedAt:Date.now(),toolName:a.toolName||s?.toolName,toolInput:a.toolInput||s?.toolInput,contextUsage:a.contextUsage||s?.contextUsage,model:a.model||s?.model};e.set(t,c),N.info(`[StateMachine] updateSession: id=${t}, state=${n}, event=${i}, total=${e.size}`),n===`idle`&&i===`Stop`&&(r=setTimeout(()=>{if(r=null,e.has(t)){let n=e.get(t);n.state=`idle`,n.updatedAt=Date.now()}N.info(`[StateMachine] doneTimer fired for ${t}, total=${e.size}`),o()},Tn)),o()}function c(t){e.delete(t),o()}function l(){let t=`idle`;for(let[,n]of e)(xn[n.state]??0)>(xn[t]??0)&&(t=n.state);return r&&t===`idle`?`done`:t}function u(){return i}function d(){let t=[];for(let[,n]of e)t.push(n);return t}function f(){let t=Date.now(),n=!1;for(let[r,i]of e){let a=t-i.updatedAt;a>Sn?(e.delete(r),N.info(`[StateMachine] cleanStale: removed ${r} (age=${Math.round(a/1e3)}s)`),n=!0):i.state!==`idle`&&a>Cn&&(i.state=`idle`,i.updatedAt=t,N.info(`[StateMachine] cleanStale: reset ${r} to idle (age=${Math.round(a/1e3)}s)`),n=!0)}n&&o()}function p(){t||=setInterval(f,wn)}function m(){t&&=(clearInterval(t),null),r&&=(clearTimeout(r),null)}return{updateSession:s,dismissSession:c,resolveDisplayState:l,getCurrentState:u,getSessions:d,subscribe:a,cleanStaleSessions:f,start:p,stop:m}}function Dn(e){return e==null?`null`:typeof e==`object`?Array.isArray(e)?`[`+e.map(Dn).join(`,`)+`]`:`{`+Object.keys(e).sort().map(t=>JSON.stringify(t)+`:`+Dn(e[t])).join(`,`)+`}`:JSON.stringify(e)}function On(e,t,n){let r=n?.tool_use_id||n?.toolUseId||null,i=n?.tool_name||n?.toolName||null,a=i!=null&&i!==``?Dn(n?.tool_input??n?.toolInput??null):null;for(let n=0;n<e.length;n++){let o=e[n];if(o.kind===`permission`&&o.sessionId===t&&(r&&o.toolUseId&&o.toolUseId===r||a!=null&&o.toolName===i&&Dn(o.toolInput??null)===a))return n}return-1}P();var kn=6e4,An=60019,jn=12e4,Mn=null;function Nn(){return Mn||(Mn=f.join(require(`os`).homedir(),`.erzhi-recording`),Mn)}function Pn(e){let t=null,n=null,r=[],i=null,a=null,o=[`PostToolUse`,`PostToolUseFailure`,`Stop`,`StopFailure`,`SessionEnd`,`ApiError`],s=[`PostToolUse`,`PostToolUseFailure`,`PermissionDenied`],c=[`Stop`,`StopFailure`,`SessionEnd`];class l extends Error{code=`PAYLOAD_TOO_LARGE`}function u(e){return new Promise((t,n)=>{let r=``;e.on(`data`,t=>{if(r+=t,Buffer.byteLength(r)>1048576){try{e.destroy()}catch{}n(new l(`Body exceeds 1MB limit`))}}),e.on(`end`,()=>{try{t(JSON.parse(r))}catch{n(Error(`Invalid JSON`))}}),e.on(`error`,n)})}function d(e,t,n){e.writeHead(t,{"Content-Type":`application/json`}),e.end(JSON.stringify(n))}function p(e,t){try{!e.headersSent&&!e.destroyed&&!e.writableEnded&&(e.writeHead(200,{"Content-Type":`application/json`}),e.end(t))}catch{}}function g(){return r[0]??null}function _(e){let t=g();t&&((t.kind===`permission`||t.answerable)&&t.reject(e),v())}function v(){r.shift(),clearTimeout(i),i=null,y(),b()}function y(){if(i&&clearTimeout(i),!r.length){i=null;return}i=setTimeout(()=>{i=null,_(`timeout`)},jn)}function b(){a&&a(g())}function x(e){let t=r.length,n=[],a=r.filter(t=>t.kind===`question`&&t.sessionId===e?(n.push(t),!1):!0);if(a.length!==t){r=a;for(let e of n)e.kind===`question`&&e.answerable&&e.reject(`completed`);clearTimeout(i),i=null,y(),b()}}function S(e,t){let n=On(r,e,t);if(n===-1)return;let[a]=r.splice(n,1);a.reject(`resolved-in-cli`),clearTimeout(i),i=null,y(),b(),N.info(`[AgentServer] permission resolved externally (CLI): session=${e}, tool=${a.toolName}`)}function C(e){let t=r.length,n=[],a=r.filter(t=>t.kind===`permission`&&t.sessionId===e?(n.push(t),!1):!0);if(a.length!==t){r=a;for(let e of n)e.reject(`completed`);clearTimeout(i),i=null,y(),b(),N.info(`[AgentServer] permissions cleared for ended session=${e}, count=${n.length}`)}}function w(t,n){let r=t.session_id||t.sessionId,i=t.state,a=t.event;if(N.info(`[AgentServer] /state received: session=${r}, state=${i}, event=${a}, tool=${t.tool_name||t.toolName}`),!r||!i||!a){N.warn(`[AgentServer] /state rejected: missing fields (sessionId=${r}, state=${i}, event=${a})`),d(n,400,{error:`Missing required fields: session_id, state, event`});return}e.updateSession(r,i,a,{agentId:t.agent_id||`claude-code`,toolName:t.tool_name||t.toolName,toolInput:t.tool_input||t.toolInput,contextUsage:t.context_usage||t.contextUsage,model:t.model}),o.includes(a)&&x(r),c.includes(a)&&C(r),s.includes(a)&&S(r,t),N.info(`[AgentServer] /state ok, total sessions=${e.getSessions().length}`),d(n,200,{ok:!0,app:`erzhi-recording`})}function T(t,n){let i=t.tool_name||t.toolName||`unknown`,a=t.tool_input||t.toolInput||{},o=t.session_id||t.sessionId||`unknown`;if(i===`AskUserQuestion`){E(n,o,a);return}e.updateSession(o,`notification`,`PermissionRequest`,{toolName:i,toolInput:a});let s=t.tool_use_id||t.toolUseId||null,c={kind:`permission`,sessionId:o,toolName:i,toolInput:a,suggestions:t.permission_suggestions||null,toolUseId:s,resolve:()=>{},reject:()=>{},createdAt:Date.now()};new Promise((e,t)=>{c.resolve=e,c.reject=t}).then(t=>{e.updateSession(o,`idle`,`PermissionResolved`);let r=t===`always`?`allow`:t,i=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:r}}});N.info(`[AgentServer] /permission resolved: behavior=${t} -> ${r}`),p(n,i)}).catch(t=>{e.updateSession(o,`idle`,`PermissionCancelled`);let r=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:`cancel`}}});N.info(`[AgentServer] /permission cancelled: ${t}`),p(n,r)}),r.push(c),r.length===1&&y(),b(),N.info(`[AgentServer] /permission queued: session=${o}, queue=${r.length}`)}function E(t,n,i){let a=Array.isArray(i&&i.questions)&&i.questions||null;e.updateSession(n,`notification`,`AskUserQuestion`,{toolName:`AskUserQuestion`,toolInput:i});let o={kind:`question`,sessionId:n,toolName:`AskUserQuestion`,toolInput:i,questions:a,answerable:!0,resolve:()=>{},reject:()=>{},createdAt:Date.now()};new Promise((e,t)=>{o.resolve=e,o.reject=t}).then(r=>{e.updateSession(n,`idle`,`QuestionAnswered`);let i=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:`allow`,updatedInput:{questions:a,answers:r}}}});N.info(`[AgentServer] AskUserQuestion answered via /permission: session=${n}`),p(t,i)}).catch(r=>{e.updateSession(n,`idle`,`QuestionDenied`);let i=JSON.stringify({hookSpecificOutput:{hookEventName:`PermissionRequest`,decision:{behavior:`deny`}}});N.info(`[AgentServer] AskUserQuestion denied: reason=${r}, session=${n}`),p(t,i)}),r.push(o),r.length===1&&y(),b(),N.info(`[AgentServer] AskUserQuestion (answerable) queued: session=${n}, queue=${r.length}`)}function D(t,n){let r=t.session_id||t.sessionId||`unknown`,i=t.tool_name||t.toolName||`AskUserQuestion`,a=t.tool_input||t.toolInput||{};e.updateSession(r,`notification`,`AskUserQuestion`,{toolName:i,toolInput:a}),N.info(`[AgentServer] /question notified (read-only card removed): session=${r}`),d(n,200,{ok:!0,app:`erzhi-recording`})}function O(t){let r=e.getSessions().length;d(t,200,{ok:!0,app:`erzhi-recording`,port:n,sessionCount:r})}function k(e,t){t.setHeader(`Access-Control-Allow-Origin`,`*`),N.info(`[AgentServer] ${e.method} ${e.url}`),e.method===`POST`&&e.url===`/state`?u(e).then(e=>w(e,t)).catch(e=>{N.error(`[AgentServer] parseBody error:`,e),d(t,e?.code===`PAYLOAD_TOO_LARGE`?413:400,{error:e?.code===`PAYLOAD_TOO_LARGE`?`Payload too large`:`Invalid JSON`})}):e.method===`POST`&&e.url===`/permission`?u(e).then(e=>T(e,t)).catch(e=>{N.error(`[AgentServer] parseBody error:`,e),d(t,e?.code===`PAYLOAD_TOO_LARGE`?413:400,{error:e?.code===`PAYLOAD_TOO_LARGE`?`Payload too large`:`Invalid JSON`})}):e.method===`POST`&&e.url===`/question`?u(e).then(e=>D(e,t)).catch(e=>{N.error(`[AgentServer] parseBody error:`,e),d(t,e?.code===`PAYLOAD_TOO_LARGE`?413:400,{error:e?.code===`PAYLOAD_TOO_LARGE`?`Payload too large`:`Invalid JSON`})}):e.method===`GET`&&e.url===`/health`?O(t):d(t,404,{error:`Not found`})}function ee(e){let t=g();t&&t.kind===`permission`&&(t.resolve(e),v())}function te(){let e=g();e&&e.kind===`question`&&(e.answerable&&e.reject(`dismissed`),v())}function ne(e,t){let n=g();n&&n.kind===`question`&&n.answerable&&n.sessionId===e?(n.resolve(t),v(),N.info(`[AgentServer] submitQuestion accepted: session=${e}`)):N.warn(`[AgentServer] submitQuestion ignored: no matching answerable head for session=${e}`)}function re(e){a=e}function A(){let e=g();return e?e.kind===`permission`?{kind:`permission`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,suggestions:e.suggestions,createdAt:e.createdAt}:{kind:`question`,sessionId:e.sessionId,toolName:e.toolName,toolInput:e.toolInput,questions:e.questions,answerable:e.answerable,createdAt:e.createdAt}:null}function j(){return new Promise(e=>{let r=kn,i=null;function a(){if(r>An){N.error(`Agent server: all ports ${kn}-${An} occupied`),e(null);return}i=h.createServer(k),i.on(`error`,t=>{t.code===`EADDRINUSE`?(r++,a()):(N.error(`Agent server error:`,t.message),e(null))}),i.listen(r,`127.0.0.1`,()=>{n=r,t=i;try{let e=Nn();m.mkdirSync(e,{recursive:!0}),m.writeFileSync(f.join(e,`runtime.json`),JSON.stringify({port:r,pid:process.pid}),`utf8`)}catch{}N.info(`Agent server listening on 127.0.0.1:${r}`),e(r)})}a()})}function M(){for(let e of r)e.kind===`permission`&&e.reject(`stopped`);r=[],clearTimeout(i),i=null,a&&a(null),t&&=(t.close(),null),n=null}function ie(){return n}return{start:j,stop:M,getPort:ie,getSafeCurrentCard:A,resolvePendingPermission:ee,dismissQuestion:te,submitQuestion:ne,setOnCardChange:re}}P();var Fn=f.join(p.homedir(),`.claude`,`settings.json`),In=300*1e3,Ln=3,Rn=[`SessionStart`,`SessionEnd`,`UserPromptSubmit`,`PreToolUse`,`PostToolUse`,`PostToolUseFailure`,`Stop`,`StopFailure`,`ApiError`,`Notification`,`PermissionRequest`];function zn(e){let t=null,n=0,r=!1;function i(){try{if(require(`electron`)?.app?.isPackaged)return f.join(process.resourcesPath,`clawd-hook.js`)}catch{}return f.join(__dirname,`clawd-hook.js`)}function a(){try{let{execSync:e}=require(`child_process`),t=e(`where node`,{encoding:`utf8`}).trim().split(`
`)[0];if(t)return t}catch{}return process.execPath.replace(`electron.exe`,`node.exe`)}function o(){try{let e=m.readFileSync(Fn,`utf8`);return JSON.parse(e)}catch{return null}}function s(e){try{return m.writeFileSync(Fn,JSON.stringify(e,null,2),`utf8`),!0}catch(e){return N.error(`Failed to write Claude settings:`,e.message),!1}}function c(e,t){return{command:`& "${a()}" "${t}" ${e}`,shell:`powershell`}}function l(e){let t=e.hooks;return!t||!Array.isArray(t)?!1:t.some(e=>e.name&&e.events&&Array.isArray(e.events))}function u(e){return l(e)?(e.hooks=(e.hooks||[]).filter(e=>!e.name?.startsWith(`erzhi-recording`)),!0):!1}function d(){let t=o();if(!t)return{added:!1,updated:!1};let n=i(),r=t.hooks||{};if(u(t),e(),Rn.every(e=>(r[e]||[]).some(t=>t.hooks?.some(t=>e===`PermissionRequest`?t.type===`http`&&t.url?.includes(`/permission`):t.type===`command`&&t.command?.startsWith(`&`)&&t.command?.includes(`clawd-hook.js`)&&t.shell===`powershell`))))return{added:!1,updated:!1};for(let t of Rn){let i;if(t===`PermissionRequest`)i={type:`http`,url:`http://127.0.0.1:${e()||6e4}/permission`,timeout:600};else{let{command:e,shell:r}=c(t,n);i={type:`command`,command:e,shell:r,async:!0,timeout:5}}r[t]=[{matcher:``,hooks:[i]}]}return t.hooks=r,s(t),{added:!0,updated:!1}}function p(){let e=o();if(!e)return{removed:!1};let t=!1;if(l(e)){let n=e.hooks.length;e.hooks=e.hooks.filter(e=>!e.name?.startsWith(`erzhi-recording`)),e.hooks.length<n&&(t=!0)}let n=e.hooks||{};for(let e of Rn)if(n[e]){let r=n[e].length;n[e]=n[e].filter(e=>!e.hooks?.some(e=>e.command?.includes(`clawd-hook.js`))),n[e].length===0?delete n[e]:n[e].length<r&&(t=!0)}return e.hooks=n,s(e),{removed:t}}function h(){let e=o();return e?((e.hooks||{})[Rn[0]]||[]).some(e=>e.hooks?.some(e=>e.command?.includes(`clawd-hook.js`))):!1}function g(){let e=[];if(!o())return e.push(`Claude settings file not found`),{healthy:!1,issues:e};if(!h())return e.push(`Hook entry missing`),{healthy:!1,issues:e};let t=i();return m.existsSync(t)?{healthy:e.length===0,issues:e}:(e.push(`Hook script file missing`),{healthy:!1,issues:e})}function _(){if(r)return!1;if(n>=Ln)return r=!0,!1;let e=d();return(e.added||e.updated)&&g().healthy?(n=0,!0):(n++,!1)}function v(){let e=g();e.healthy?(n>0&&(n=0),r&&=!1):(N.warn(`Claude hook health check failed:`,e.issues.join(`, `)),_())}function y(){t||(v(),t=setInterval(v,In),N.info(`Claude hook watcher started`))}function b(){t&&=(clearInterval(t),null)}function x(){let e=g();return{installed:h(),scriptExists:m.existsSync(i()),claudeExists:o()!==null,healthy:e.healthy,repairFailures:n,manualFixRequired:r}}return{install:d,uninstall:p,isInstalled:h,startWatcher:y,stopWatcher:b,getStatus:x,checkHealth:g,repair:_}}P();function Bn(e={}){let t=En(),n=Pn(t),r=zn(()=>n.getPort()),i=null,a=null,o=!1;t.subscribe((e,t)=>{i&&i(e,t)}),n.setOnCardChange(e=>{if(o&&e&&e.kind===`permission`){N.info(`[AgentBridge] auto-allow permission: tool=${e.toolName}`),n.resolvePendingPermission(`allow`);return}a&&a(e)});async function s(){if(t.start(),await n.start()!==null){if(e.autoInstallHooks!==!1){let e=r.install();e.added&&N.info(`Claude Code hooks installed`),e.updated&&N.info(`Claude Code hooks updated`)}e.autoStartWatcher!==!1&&r.isInstalled()&&r.startWatcher()}}function c(){r.stopWatcher(),t.stop(),n.stop()}function l(){return n}function u(){return t}function d(){return r}function f(e){i=e}function p(e){a=e}function m(e){n.resolvePendingPermission(e)}function h(){n.dismissQuestion()}function g(e,t){n.submitQuestion(e,t)}function _(){r.install()}function v(){r.uninstall()}function y(e){o=e,N.info(`[AgentBridge] autoAllow=${e}`)}function b(){return o}let x=null,S=0;function C(){let e=Date.now();if(x!==null&&e-S<3e4)return x;try{let{execSync:e}=require(`child_process`);x=e(`tasklist /NH /FI "IMAGENAME eq claude.exe"`,{encoding:`utf8`,timeout:2e3}).includes(`claude.exe`)}catch{x=!1}return S=e,x}function w(){let e=t.getSessions(),i=e.length,a=t.getCurrentState(),o=e.map(e=>e.sessionId).join(`,`);N.info(`[AgentBridge] getStatus: real_count=${i}, ids=[${o}], display=${a}`);let s=t.getSessions().length;return{serverRunning:n.getPort()!==null,port:n.getPort(),hookInstalled:r.isInstalled(),hookManagerStatus:r.getStatus(),displayState:a,currentCard:n.getSafeCurrentCard(),sessionCount:s,claudeRunning:C()}}return{start:s,stop:c,getServer:l,getStateMachine:u,getHookManager:d,getStatus:w,setStateListener:f,setCardListener:p,resolvePermission:m,dismissQuestion:h,submitQuestion:g,installHooks:_,uninstallHooks:v,setAutoAllow:y,getAutoAllow:b}}var Vn=`local-video`;function Hn(){d.protocol.registerSchemesAsPrivileged([{scheme:Vn,privileges:{standard:!0,secure:!0,supportFetchAPI:!0,stream:!0}}])}function Un(){d.protocol.handle(Vn,e=>{let t=new URL(e.url),n=decodeURIComponent(t.pathname).replace(/^\//,``),r=e.headers.get(`range`),i=0;try{i=(0,g.statSync)(n).size}catch{return new Response(`File not found: `+n,{status:404})}let a=(0,u.extname)(n).toLowerCase(),o=a===`.mp4`?`video/mp4`:a===`.webm`?`video/webm`:`application/octet-stream`;if(r){let e=/bytes=(\d*)-(\d*)/.exec(r),t=e&&e[1]?parseInt(e[1],10):0,a=e&&e[2]?parseInt(e[2],10):i-1,s=Math.min(a,i-1),c=(0,g.createReadStream)(n,{start:t,end:s});return new Response(C.Readable.toWeb(c),{status:206,headers:{"Content-Range":`bytes ${t}-${s}/${i}`,"Accept-Ranges":`bytes`,"Content-Length":String(s-t+1),"Content-Type":o}})}let s=(0,g.createReadStream)(n);return new Response(C.Readable.toWeb(s),{status:200,headers:{"Content-Length":String(i),"Content-Type":o,"Accept-Ranges":`bytes`}})})}function Wn(e,t){let n=new Date(t).toISOString();return e.filter(e=>!!e.reminder&&!e.reminderFired&&!(e.type===`todo`&&e.done)&&e.reminder<=n)}function Gn(e){return e?String(e).replace(/<img[^>]*alt=["']([^"']*)["'][^>]*>/gi,(e,t)=>t||`[图]`).replace(/<img[^>]*>/gi,`[图]`).replace(/<br\s*\/?>/gi,` `).replace(/<\/(p|div|h[1-6]|li|blockquote)>/gi,` `).replace(/<[^>]+>/gi,``).replace(/&nbsp;/g,` `).replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`).replace(/&quot;/g,`"`).replace(/&#39;/g,`'`).replace(/\s+/g,` `).trim():``}P();var Kn=3e4,qn=null;function Jn(){let e=Wn(q(),Date.now());if(e.length!==0){for(let t of e){let e=Gn(t.title).trim(),n=Gn(t.content).trim().slice(0,120);try{new d.Notification({title:e?`⏰ ${e}`:`⏰ 待办提醒`,body:n||`到时间了，记得处理一下。`}).show()}catch(e){N.warn(`Todo reminder notification failed:`,e?.message??e)}Ut(t.id)}tn()||Yt(!0)}}function Yn(){qn||(Jn(),qn=setInterval(Jn,Kn),N.info(`Todo reminder scheduler started`))}function Xn(){qn&&=(clearInterval(qn),null),N.info(`Todo reminder scheduler stopped`)}P(),Hn();var Z=null,Q=null,$=null,Zn=null,Qn=null,$n=process.env.VITE_DEV_SERVER_URL;function er(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e)}function tr(e){Z=new d.BrowserWindow({icon:er(),width:550,height:420,minWidth:420,minHeight:340,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`二支录制`,backgroundColor:`#eaeaec`,webPreferences:{preload:e,contextIsolation:!0,nodeIntegration:!1,sandbox:!1,backgroundThrottling:!1}}),$n?Z.loadURL($n):Z.loadFile((0,u.join)(process.env.DIST,`index.html`)),Z.on(`close`,e=>{d.app.isQuitting||(e.preventDefault(),Z?.hide())})}d.app.on(`gpu-process-crashed`,(e,t)=>{N.error(`GPU process crashed:`,JSON.stringify(t))}),d.app.whenReady().then(()=>{process.env.DIST=(0,u.join)(__dirname,`../../dist`),process.env.VITE_PUBLIC=d.app.isPackaged?process.env.DIST:(0,u.join)(__dirname,`../../public`),Un(),ge(),N.info(`App starting...`),xe(N),Oe(N);let e=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);Zn=Bn({autoInstallHooks:!0,autoStartWatcher:!0}),Zn.start().catch(e=>{N.error(`Agent bridge start failed:`,e?.message??e)}),on(Zn),tr(e),(0,L.setMainWindow)(Z),(0,dt.createTray)(),ln(Z),Ze(),yn(),Zt(),Yn(),J();try{let e=U();d.app.setLoginItemSettings({openAtLogin:e.openAtLogin})}catch(e){N.error(`Sync openAtLogin on startup failed:`,e)}d.ipcMain.handle(`show-ai-window`,()=>{nr()}),d.ipcMain.handle(`show-settings-window`,()=>{rr()}),d.ipcMain.handle(`show-main-window`,()=>{Z&&!Z.isDestroyed()&&(Z.show(),Z.focus())}),process.on(`clawd-show-record-window`,()=>{Z&&!Z.isDestroyed()&&(Z.show(),Z.focus())}),process.on(`clawd-show-ai-window`,()=>{nr()}),process.on(`clawd-show-settings-window`,()=>{rr()}),process.on(`clawd-show-todo-window`,()=>{$t()}),Qn=setInterval(bn,3e4),d.app.on(`activate`,()=>{d.BrowserWindow.getAllWindows().length===0&&tr(e)})}),d.app.on(`window-all-closed`,()=>{}),d.app.on(`before-quit`,()=>{d.app.isQuitting=!0;for(let e of d.BrowserWindow.getAllWindows())if(!e.isDestroyed())try{e.webContents.send(`app-before-quit`)}catch{}(0,L.hideRegionBorder)(),(0,L.hideFloatingIsland)(),(0,L.hideCameraPreview)(),nt(),Zn?.stop(),Et(),Se(),Xn(),en(),un(),(0,dt.destroyTray)(),Qn&&=(clearInterval(Qn),null),Z=null,Q=null,$=null});function nr(){if(Q&&!Q.isDestroyed()){Q.show(),Q.focus();return}let e=process.env.VITE_DEV_SERVER_URL,t=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);Q=new d.BrowserWindow({icon:er(),width:480,height:540,minWidth:400,minHeight:400,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`AI 助手`,backgroundColor:`#eaeaec`,webPreferences:{preload:t,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),e?Q.loadURL(`${e}#/ai?t=${Date.now()}`):Q.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/ai`}),Q.once(`ready-to-show`,()=>{Q?.show()}),Q.on(`closed`,()=>{Q=null})}function rr(){if($&&!$.isDestroyed()){$.show(),$.focus();return}let e=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);$=new d.BrowserWindow({icon:er(),width:420,height:480,minWidth:380,minHeight:420,show:!1,skipTaskbar:!1,frame:!1,titleBarStyle:`hidden`,title:`设置`,backgroundColor:`#eaeaec`,webPreferences:{preload:e,contextIsolation:!0,nodeIntegration:!1,sandbox:!1}}),$n?$.loadURL(`${$n}#/settings?t=${Date.now()}`):$.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/settings`}),$.once(`ready-to-show`,()=>{$?.show()}),$.on(`closed`,()=>{$=null})}