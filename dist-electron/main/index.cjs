...
</body></html>`;l.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(T)}`),V.info(`Region border+toolbar shown (split windows):`,e),b=e,t?.cameraEnabled&&E(e,t.cameraDeviceId),p&&clearInterval(p),p=setInterval(()=>{l&&!l.isDestroyed()&&l.setAlwaysOnTop(!0,`screen-saver`),f&&!f.isDestroyed()&&f.setAlwaysOnTop(!0,`screen-saver`),g&&!g.isDestroyed()&&g.setAlwaysOnTop(!0,`screen-saver`)},5e3)}function ne(e,t){f&&!f.isDestroyed()&&(f.webContents.send(`toolbar-state`,e,t,h),(e===`recording`||e===`paused`)&&h===`inside`&&m&&f.setBounds({x:m.x+8,y:m.y+8,width:170,height:40}))}function L(){l&&!l.isDestroyed()&&(l.close(),l=null)}function R(){p&&=(clearInterval(p),null),L(),f&&!f.isDestroyed()&&(f.close(),f=null),D(),b=null,V.info(`Region border hidden`)}function re(){d.ipcMain.on(`region-selected`,(e,t)=>{V.info(`Region selected:`,t),c(t)}),d.ipcMain.on(`region-cancelled`,()=>{V.info(`Region selection cancelled`),c(null)}),d.ipcMain.handle(`show-region-border`,(e,t,n)=>{te(t,n)}),d.ipcMain.handle(`hide-region-border`,()=>{R()}),d.ipcMain.handle(`hide-border-only`,()=>{L()}),d.ipcMain.handle(`update-toolbar-state`,(e,t,n)=>{ne(t,n)}),d.ipcMain.on(`toolbar-action`,(e,t)=>{if(V.info(`Toolbar action:`,t),t===`close`){n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,`close`),R();return}n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,t)}),d.ipcMain.removeHandler(`set-mouse-ignore`),d.ipcMain.removeAllListeners(`set-mouse-ignore`),d.ipcMain.handle(`show-floating-island`,(e,t,n)=>{N(t,n)}),d.ipcMain.handle(`hide-floating-island`,()=>{P()}),d.ipcMain.handle(`hide-camera-preview`,()=>{D()}),d.ipcMain.handle(`toggle-camera-preview`,(e,t,n)=>{t&&b?E(b,n):D()}),d.ipcMain.on(`camera-drag-start`,()=>w()),d.ipcMain.on(`camera-drag-end`,()=>T()),d.ipcMain.handle(`set-island-state`,(e,t,n)=>{F(t,n)}),d.ipcMain.on(`island-action`,(e,t)=>{V.info(`Island action:`,t),n&&!n.isDestroyed()&&n.webContents.send(`on-toolbar-action`,t)}),d.ipcMain.on(`resize-island`,(e,t,n)=>{if(O&&!O.isDestroyed()){let e=M||d.screen.getPrimaryDisplay().bounds,r=t+20,i=Math.round(e.x+(e.width-r)/2),a=n||44;O.setBounds({x:i,y:e.y+4,width:r,height:a})}})}t.exports={selectRegion:s,showRegionBorder:te,hideRegionBorder:R,hideBorderOnly:L,updateToolbarState:ne,updateAudioLevels:i,showFloatingIsland:N,hideFloatingIsland:P,showCameraPreview:E,hideCameraPreview:D,setFloatingIslandState:F,setMainWindow:r,registerRegionSelectorHandlers:re}})),me=pe();H();var U=null,W=null,G=null,K=66,q=240,he=`floating-ball-pos.json`;function ge(){return(0,u.join)(d.app.isPackaged?d.app.getPath(`userData`):(0,u.join)(__dirname,`..`,`..`),he)}function _e(){try{let e=g.default.readFileSync(ge(),`utf-8`),t=JSON.parse(e);if(typeof t.x==`number`&&typeof t.y==`number`)return t}catch{}return null}function ve(e){try{g.default.writeFileSync(ge(),JSON.stringify(e),`utf-8`)}catch{}}function ye(){if(U&&!U.isDestroyed()){U.show(),U.focus();return}if(!W){let e=_e();if(e)W=e;else{let e=d.screen.getPrimaryDisplay().bounds;W={x:Math.round(e.x+(e.width-K)/2),y:Math.round(e.y+(e.height-K)/2)}}}U=new d.BrowserWindow({x:W.x,y:W.y,width:K,height:K,frame:!1,transparent:!0,backgroundColor:`#00000000`,resizable:!1,alwaysOnTop:!0,skipTaskbar:!0,hasShadow:!1,show:!1,webPreferences:{nodeIntegration:!0,contextIsolation:!1}}),U.setVisibleOnAllWorkspaces(!0),U.setAlwaysOnTop(!0,`screen-saver`);let e=Te();U.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(e)}`),U.once(`ready-to-show`,()=>{U?.show(),U&&!U.isDestroyed()&&U.webContents.executeJavaScript(`ensureMenu()`).catch(()=>{})}),U.on(`closed`,()=>{U=null}),U.on(`move`,()=>{if(U&&!U.isDestroyed()){let[e,t]=U.getPosition();W={x:e,y:t}}}),U.on(`close`,()=>{W&&ve(W)}),V.info(`Floating ball shown`)}function be(){if(U&&!U.isDestroyed()){let[e,t]=U.getPosition();W={x:e,y:t},ve(W),U.close(),U=null,V.info(`Floating ball hidden`)}}async function xe(){if(!U||U.isDestroyed())return;let[e,t]=U.getPosition(),n=Math.round(e+K/2),r=Math.round(t+K/2);V.info(`[Ball] expand at`,[e,t],`center`,[n,r]),U.setOpacity(0),U.setBounds({x:n-q/2,y:r-q/2,width:q,height:q});try{await U.webContents.executeJavaScript(`ensureMenu(); document.body.offsetHeight; document.body.classList.add('expanded'); isExpanded=true; void 0;`)}catch{}if(!(!U||U.isDestroyed())){try{await U.capturePage()}catch{}!U||U.isDestroyed()||(U.setOpacity(1),U.webContents.send(`ball-state`,`expanded`))}}async function Se(){if(!U||U.isDestroyed())return;let[e,t]=U.getPosition(),n=Math.round(e+q/2),r=Math.round(t+q/2);V.info(`[Ball] collapse at`,[e,t],`center`,[n,r]),U.setOpacity(0);try{await U.webContents.executeJavaScript(`document.body.classList.remove('expanded');
       var s=document.getElementById('ringSvg');while(s.firstChild){s.removeChild(s.firstChild)}
       menuCreated=false; isExpanded=false; void 0;`)}catch{}if(!U||U.isDestroyed())return;let i=n-K/2,a=r-K/2;U.setBounds({x:i,y:a,width:K,height:K});let[o,s]=U.getPosition();(o!==i||s!==a)&&U.setBounds({x:i+(i-o),y:a+(a-s),width:K,height:K}),U.setOpacity(1)}function Ce(e){let t=d.BrowserWindow.getAllWindows().find(e=>!e.isDestroyed()&&e!==U);t&&!t.isDestroyed()&&t.webContents.send(`on-floating-ball-action`,e),Se()}var J=null;function we(e=48){if(J)return J;try{let t=[(0,u.join)(__dirname,`..`,`..`,`public`,`logo.png`),(0,u.join)(__dirname,`..`,`public`,`logo.png`),(0,u.join)(__dirname,`..`,`..`,`resources`,`logo.png`)];for(let n of t)if(g.default.existsSync(n))return J=d.nativeImage.createFromPath(n).resize({width:e,height:e,quality:`good`}).toDataURL(),J}catch{}return``}function Te(){return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<style>
...
</html>`}function Ee(){d.ipcMain.handle(`show-floating-ball`,()=>{ye()}),d.ipcMain.handle(`hide-floating-ball`,()=>{be()}),d.ipcMain.handle(`toggle-floating-ball`,()=>{be()}),d.ipcMain.on(`floating-ball-expand`,()=>{xe()}),d.ipcMain.on(`floating-ball-collapse`,()=>{Se()}),d.ipcMain.on(`floating-ball-action`,(e,t)=>{V.info(`Floating ball action:`,t),Ce(t)});let e=null;d.ipcMain.on(`floating-ball-drag-start`,(t,n,r)=>{if(!U||U.isDestroyed())return;let[i,a]=U.getPosition(),[o,s]=U.getSize();G={winX:i,winY:a,scrX:n,scrY:r},e={w:o,h:s}}),d.ipcMain.on(`floating-ball-move`,(t,n,r)=>{if(!U||U.isDestroyed()||!G||!e)return;let i=n-G.scrX,a=r-G.scrY,o=Math.round(G.winX+i),s=Math.round(G.winY+a);U.setBounds({x:o,y:s,width:e.w,height:e.h});let[c,l]=U.getPosition();(c!==o||l!==s)&&U.setBounds({x:o+(o-c),y:s+(s-l),width:e.w,height:e.h})}),d.ipcMain.on(`floating-ball-drag-end`,()=>{G=null,e=null,W&&ve(W)})}var Y=s(((e,t)=>{H();var n=null;function r(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e).resize({width:16,height:16})}function i(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.png`):(0,u.join)(__dirname,`../../public/logo.png`);return e?d.nativeImage.createFromPath(e).resize({width:64,height:64,quality:`better`}):d.nativeImage.createEmpty()}function a(){if(n&&!n.isDestroyed())return;n=new d.Tray(r()),n.setToolTip(`二支录制`);let e=d.Menu.buildFromTemplate([{label:`显示主窗口`,click:()=>{let e=d.BrowserWindow.getAllWindows()[0];e&&(e.show(),e.focus())}},{type:`separator`},{label:`退出`,click:()=>{let{app:e}=require(`electron`);e.quit()}}]);n.setContextMenu(e),n.on(`click`,()=>{let e=d.BrowserWindow.getAllWindows()[0];e&&(e.show(),e.focus())}),V.info(`System tray created`)}function o(e,t){n&&!n.isDestroyed()&&(n.displayBalloon({title:e,content:t,icon:i()}),V.info(`Tray balloon:`,e,t))}function s(){n&&!n.isDestroyed()&&(n.destroy(),n=null)}t.exports={createTray:a,showBalloon:o,destroyTray:s}}))();H();var{updateAudioLevels:De}=pe();function Oe(){return(0,u.join)(d.app.getPath(`userData`),`recordings.json`)}function ke(e){(0,me.registerRegionSelectorHandlers)(),Ee(),d.ipcMain.handle(`select-region`,async()=>(0,me.selectRegion)()),d.ipcMain.handle(`get-sources`,async(e,t)=>(await d.desktopCapturer.getSources({types:t??[`screen`,`window`],thumbnailSize:{width:340,height:200},fetchWindowIcons:!0})).map(e=>({id:e.id,name:e.name,display_id:e.display_id,appIcon:e.appIcon?.toDataURL()||null,thumbnail:e.thumbnail.toDataURL()}))),d.ipcMain.handle(`get-system-audio-sources`,async()=>{try{return(await d.desktopCapturer.getSources({types:[`audio`]})).map(e=>({id:e.id,name:e.name}))}catch{return[]}}),d.ipcMain.handle(`show-save-dialog`,async(e,t)=>{let n=d.BrowserWindow.getFocusedWindow();return n?d.dialog.showSaveDialog(n,{title:t?.title??`Save Recording`,defaultPath:t?.defaultPath??`recording-${Date.now()}.webm`,filters:t?.filters??[{name:`WebM Video`,extensions:[`webm`]},{name:`MP4 Video`,extensions:[`mp4`]},{name:`GIF`,extensions:[`gif`]}]}):{canceled:!0,filePath:null}}),d.ipcMain.handle(`show-open-dialog`,async(e,t)=>{let n=d.BrowserWindow.getFocusedWindow();return n?d.dialog.showOpenDialog(n,{title:t?.title??`Select File`,defaultPath:t?.defaultPath,filters:t?.filters??[{name:`Video Files`,extensions:[`webm`,`mp4`,`gif`]}],properties:t?.properties}):{canceled:!0,filePaths:[]}}),d.ipcMain.handle(`get-default-save-dir`,async()=>d.app.getPath(`videos`)||d.app.getPath(`desktop`)),d.ipcMain.handle(`write-file`,async(e,t,n)=>{try{return await g.default.promises.mkdir((0,u.dirname)(n),{recursive:!0}),await g.default.promises.writeFile(n,t),V.info(`保存文件`,n),{success:!0,filePath:n}}catch(e){return V.error(`保存文件失败`,n,e.message),{success:!1,filePath:n,error:e.message}}}),d.ipcMain.handle(`read-file`,async(e,t)=>{try{return(await g.default.promises.readFile(t)).buffer}catch(e){throw Error(`Failed to read file: ${e.message}`)}}),d.ipcMain.handle(`file-exists`,async(e,t)=>{try{return await g.default.promises.access(t),!0}catch{return!1}}),d.ipcMain.handle(`delete-file`,async(e,t)=>{try{return await g.default.promises.unlink(t),!0}catch{return!1}}),d.ipcMain.handle(`get-file-size`,async(e,t)=>{try{return(await g.default.promises.stat(t)).size}catch{return 0}});function t(e,t,...n){if(!(!e||e.isDestroyed()))try{e.webContents.send(t,...n)}catch{}}d.ipcMain.handle(`convert-to-mp4`,async(e,n,r,i)=>{V.info(`转换为 MP4`,n,`->`,r,i?`crop: ${i.width}x${i.height}`:``);let a=d.BrowserWindow.fromWebContents(e.sender);return le(n,r,e=>{t(a,`on-conversion-progress`,e)},i)}),d.ipcMain.handle(`crop-video`,async(e,n,r,i)=>{V.info(`裁剪视频`,n,`->`,r,`crop: ${i.width}x${i.height}+${i.x}+${i.y}`);let a=d.BrowserWindow.fromWebContents(e.sender);return ue(n,r,i,e=>{t(a,`on-conversion-progress`,e)})}),d.ipcMain.handle(`convert-to-gif`,async(e,n,r,i)=>{V.info(`转换为 GIF`,n,`->`,r);let a=d.BrowserWindow.fromWebContents(e.sender);return fe(n,r,i,e=>{t(a,`on-conversion-progress`,e)})}),d.ipcMain.handle(`merge-multi-screen`,async(e,n,r)=>{V.info(`合并多屏录制`,n.length,`个屏幕 ->`,r);let i=d.BrowserWindow.fromWebContents(e.sender);return de(n,r,e=>{t(i,`on-conversion-progress`,e)})}),d.ipcMain.handle(`open-file-location`,async(e,t)=>{d.shell.showItemInFolder(t)}),d.ipcMain.handle(`open-external`,async(e,t)=>{d.shell.openExternal(t)}),d.ipcMain.handle(`open-path`,async(e,t)=>{await d.shell.openPath(t)}),d.ipcMain.handle(`get-app-version`,async()=>d.app.getVersion()),d.ipcMain.handle(`get-screen-scale-factor`,async()=>d.screen.getPrimaryDisplay().scaleFactor),d.ipcMain.handle(`get-screen-bounds`,async()=>{let e=d.screen.getPrimaryDisplay(),t=e.scaleFactor;return{x:Math.round(e.bounds.x/t),y:Math.round(e.bounds.y/t),width:Math.round(e.bounds.width/t),height:Math.round(e.bounds.height/t)}}),d.ipcMain.handle(`take-screenshot`,async e=>{try{let e=await d.desktopCapturer.getSources({types:[`screen`],thumbnailSize:{width:0,height:0}});if(!e.length)throw Error(`未找到屏幕源`);let t=e[0].thumbnail.toPNG(),n=new Date,r=`截图_${n.getFullYear()}${String(n.getMonth()+1).padStart(2,`0`)}${String(n.getDate()).padStart(2,`0`)}_${String(n.getHours()).padStart(2,`0`)}${String(n.getMinutes()).padStart(2,`0`)}${String(n.getSeconds()).padStart(2,`0`)}.png`,i=(0,u.join)(d.app.getPath(`desktop`),r);return await g.default.promises.writeFile(i,t),(0,Y.showBalloon)(`二支录制`,`截图已保存到桌面：${r}`),{success:!0,filePath:i}}catch(e){return V.error(`截图失败`,e.message),{success:!1,error:e.message}}}),d.ipcMain.handle(`get-all-displays`,async()=>{let e=d.screen.getAllDisplays(),t=d.screen.getPrimaryDisplay(),n=await d.desktopCapturer.getSources({types:[`screen`],thumbnailSize:{width:340,height:200}});return e.map((e,r)=>{let i=n[r];return{id:e.id,label:e.id===t.id?`主屏幕`:`屏幕 ${r+1}`,bounds:e.bounds,scaleFactor:e.scaleFactor,size:{width:e.size.width,height:e.size.height},isPrimary:e.id===t.id,sourceId:i?.id||null,sourceName:i?.name||``,thumbnail:i?.thumbnail?.toDataURL()||``}})}),d.ipcMain.handle(`minimize-window`,async e=>{d.BrowserWindow.fromWebContents(e.sender)?.minimize()}),d.ipcMain.handle(`show-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t&&(t.show(),t.focus())}),d.ipcMain.handle(`maximize-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t?.isMaximized()?t.unmaximize():t?.maximize()}),d.ipcMain.handle(`close-window`,async e=>{let t=d.BrowserWindow.fromWebContents(e.sender);t&&t.hide()}),d.ipcMain.on(`notify-conversion-start`,()=>{(0,Y.showBalloon)(`二支录制`,`录制完成，正在转换视频格式...`)}),d.ipcMain.on(`show-about-window`,()=>{let e=d.BrowserWindow.getFocusedWindow();if(e){let t=new d.BrowserWindow({width:360,height:400,resizable:!1,frame:!1,modal:!0,parent:e,backgroundColor:`#eaeaec`,webPreferences:{preload:(0,u.join)(__dirname,`..`,`preload`,`index.cjs`),contextIsolation:!0,nodeIntegration:!1,sandbox:!1}});d.ipcMain.on(`close-about-window`,()=>{t.close(),d.ipcMain.removeAllListeners(`close-about-window`)}),t.on(`closed`,()=>{d.ipcMain.removeAllListeners(`close-about-window`)});let n=process.env.VITE_DEV_SERVER_URL?`${process.env.VITE_DEV_SERVER_URL}about.html`:(0,u.join)(d.app.getAppPath(),`dist`,`about.html`);n.startsWith(`http`)?t.loadURL(n):t.loadFile(n)}}),d.ipcMain.on(`notify-conversion-done`,()=>{(0,Y.showBalloon)(`二支录制`,`视频转换完成！`)}),d.ipcMain.on(`update-audio-levels`,(e,t,n)=>{De(t,n)}),d.ipcMain.handle(`load-recordings`,async()=>{let e=Oe();try{let t=await g.default.promises.readFile(e,`utf-8`),n=JSON.parse(t);return V.info(`加载录制历史`,e,n.length,`条`),n}catch(t){return V.info(`加载录制历史失败（可能首次运行）`,e,t.message),[]}}),d.ipcMain.handle(`save-recordings`,async(e,t)=>{let n=Oe();try{return await g.default.promises.writeFile(n,JSON.stringify(t),`utf-8`),V.info(`保存录制历史`,n,t.length,`条`),!0}catch(e){return V.error(`保存录制历史失败`,n,e.message),!1}}),e&&(e.setStateListener((e,t)=>{let n=d.BrowserWindow.getAllWindows();for(let r of n)if(!r.isDestroyed())try{r.webContents.send(`agent-state-update`,{state:e,sessions:t})}catch{}}),e.setPermissionListener(e=>{let t=d.BrowserWindow.getAllWindows();for(let n of t)if(!n.isDestroyed())try{n.webContents.send(`agent-permission-request`,e)}catch{}}),d.ipcMain.handle(`agent-get-status`,()=>e?.getStatus()??null),d.ipcMain.handle(`agent-install-hooks`,()=>(e?.installHooks(),e?.getStatus())),d.ipcMain.handle(`agent-uninstall-hooks`,()=>(e?.uninstallHooks(),e?.getStatus())),d.ipcMain.handle(`agent-set-auto-start`,(t,n)=>e?.setAutoStart(n)),d.ipcMain.handle(`agent-resolve-permission`,(t,n)=>e?.resolvePermission(n)))}H();var Ae=null;function je(e){Ae=e,d.globalShortcut.register(`CommandOrControl+Shift+R`,()=>{V.info(`Global shortcut: start/stop recording`),Ae?.webContents.send(`on-global-shortcut`,`startStop`)}),d.globalShortcut.register(`CommandOrControl+Shift+P`,()=>{V.info(`Global shortcut: pause/resume recording`),Ae?.webContents.send(`on-global-shortcut`,`pauseResume`)}),V.info(`Global shortcuts registered`)}function Me(){d.globalShortcut.unregisterAll()}H();var Ne=`http://8.163.43.7:3000/report-ip`;function X(){return(0,u.join)(d.app.getPath(`userData`),`pending-reports.json`)}function Pe(e){let t=[];try{g.default.existsSync(X())&&(t=JSON.parse(g.default.readFileSync(X(),`utf-8`)))}catch{}t.push(e),g.default.writeFileSync(X(),JSON.stringify(t,null,2),`utf-8`),V.info(`Saved offline report to local, total pending:`,t.length)}function Fe(){try{if(g.default.existsSync(X()))return JSON.parse(g.default.readFileSync(X(),`utf-8`))}catch{}return[]}function Ie(){try{g.default.unlinkSync(X())}catch{}}async function Le(e){try{return await fetch(Ne,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),!0}catch{return!1}}async function Re(){let e=Fe();if(e.length===0)return!0;let t=[];for(let n of e)await Le(n)?V.info(`Flushed pending report:`,n.公网IP,n.上报时间):t.push(n);return t.length===0?(Ie(),V.info(`All pending reports flushed`),!0):(g.default.writeFileSync(X(),JSON.stringify(t,null,2),`utf-8`),V.info(`Some pending reports still failed, remaining:`,t.length),!1)}async function ze(){let e=[async()=>{let e=(await fetch(`https://qifu.baidu.com/opus/api/ip/local`,{headers:{Referer:`https://www.baidu.com`}}).then(e=>e.json()))?.data;if(!e?.ip)throw Error(`empty`);return{公网IP:e.ip,国家:e.country||``,省份:e.province||``,城市:e.city||``,区县:e.district||e.area||``,详细地址:[e.country,e.province,e.city,e.district||e.area].filter(Boolean).join(``),运营商:e.isp||``}},async()=>{let e=await fetch(`http://whois.pconline.com.cn/ipJson.jsp`).then(e=>e.arrayBuffer()),t=new TextDecoder(`gbk`).decode(e),n=JSON.parse(t);if(!n.ip)throw Error(`empty`);return{公网IP:n.ip,国家:`中国`,省份:n.pro||``,城市:n.city||``,区县:n.region||``,详细地址:n.addr||``,运营商:n.addr?.split(` `)?.[1]||``}},async()=>{let e=await fetch(`http://ip-api.com/json/?lang=zh-CN`).then(e=>e.json());if(!e.query)throw Error(`empty`);return{公网IP:e.query,国家:e.country,省份:e.regionName,城市:e.city,区县:``,详细地址:`${e.country}${e.regionName}${e.city}`,运营商:e.isp,纬度:String(e.lat??``),经度:String(e.lon??``)}}];for(let t of e)try{return await t()}catch{continue}return{公网IP:``,国家:``,省份:``,城市:``,区县:``,详细地址:``,运营商:``}}function Be(){let e=(0,y.networkInterfaces)();for(let t of Object.keys(e))for(let n of e[t])if(n.family===`IPv4`&&!n.internal)return n.address;return`127.0.0.1`}async function Ve(){let e=Be(),t={电脑名:(0,y.hostname)(),局域网IP:e,上报时间:new Date().toISOString()},n;try{n=await ze()}catch{n={公网IP:``,国家:``,省份:``,城市:``,区县:``,详细地址:``,运营商:``}}let r={...t,...n};await Le(r)?(V.info(`IP reported:`,n.公网IP,n.省份,n.城市),Re()):(V.info(`Network unavailable, saving report locally`),Pe(r))}function He(){let e=Fe();e.length>0&&(V.info(`Retrying pending reports:`,e.length),Re())}var Ue={error:4,notification:3,working:2,thinking:1,idle:0},We=600*1e3,Ge=300*1e3,Ke=10*1e3,qe=2e3;function Je(){let e=new Map,t=null,n=[],r=null,i=`idle`;function a(e){return n.push(e),()=>{n=n.filter(t=>t!==e)}}function o(){let t=l();if(t!==i){i=t;let r=Array.from(e.values());for(let e of n)e(t,r)}}function s(t,n,i,a={}){r&&=(clearTimeout(r),null);let s=e.get(t),c={sessionId:t,agentId:a.agentId||`claude-code`,state:n,event:i,updatedAt:Date.now(),toolName:a.toolName||s?.toolName,toolInput:a.toolInput||s?.toolInput,contextUsage:a.contextUsage||s?.contextUsage,model:a.model||s?.model};e.set(t,c),n===`idle`&&i===`Stop`&&(r=setTimeout(()=>{if(r=null,e.has(t)){let n=e.get(t);n.state=`idle`,n.updatedAt=Date.now()}o()},qe)),o()}function c(t){e.delete(t),o()}function l(){let t=`idle`;for(let[,n]of e)(Ue[n.state]??0)>(Ue[t]??0)&&(t=n.state);return r&&t===`idle`?`done`:t}function u(){return i}function d(){return Array.from(e.values())}function f(){let t=Date.now(),n=!1;for(let[r,i]of e){let a=t-i.updatedAt;a>We?(e.delete(r),n=!0):i.state!==`idle`&&a>Ge&&(i.state=`idle`,i.updatedAt=t,n=!0)}n&&o()}function p(){t||=setInterval(f,Ke)}function m(){t&&=(clearInterval(t),null),r&&=(clearTimeout(r),null)}return{updateSession:s,dismissSession:c,resolveDisplayState:l,getCurrentState:u,getSessions:d,subscribe:a,cleanStaleSessions:f,start:p,stop:m}}H();var Ye=23338,Xe=23342,Ze=12e4,Qe=null;function $e(){return Qe||(Qe=f.join(require(`os`).homedir(),`.erzhi-recording`),Qe)}function et(e){let t=null,n=null,r=null,i=null,a=null;function o(e){return new Promise((t,n)=>{let r=``;e.on(`data`,e=>{r+=e}),e.on(`end`,()=>{try{t(JSON.parse(r))}catch{n(Error(`Invalid JSON`))}}),e.on(`error`,n)})}function s(e,t,n){e.writeHead(t,{"Content-Type":`application/json`}),e.end(JSON.stringify(n))}function c(t,n){let r=t.session_id||t.sessionId,i=t.state,a=t.event;if(!r||!i||!a){s(n,400,{error:`Missing required fields: session_id, state, event`});return}e.updateSession(r,i,a,{agentId:t.agent_id||`claude-code`,toolName:t.tool_name||t.toolName,toolInput:t.tool_input||t.toolInput,contextUsage:t.context_usage||t.contextUsage,model:t.model}),s(n,200,{ok:!0,app:`erzhi-recording`})}function l(t,n){let o=t.tool_name||t.toolName||`unknown`,c=t.tool_input||t.toolInput||{},l=t.session_id||t.sessionId||`unknown`;e.updateSession(l,`notification`,`PermissionRequest`,{toolName:o,toolInput:c}),r&&(r.reject(`superseded`),i&&clearTimeout(i)),new Promise((e,n)=>{r={sessionId:l,toolName:o,toolInput:c,suggestions:t.permission_suggestions||null,resolve:e,reject:n,createdAt:Date.now()},i=setTimeout(()=>{r&&(r.reject(`timeout`),r=null,i=null)},Ze),a&&a(r)}).then(t=>{n.headersSent||(e.updateSession(l,`idle`,`PermissionResolved`),s(n,200,{behavior:t}))}).catch(t=>{n.headersSent||(e.updateSession(l,`idle`,`PermissionCancelled`),s(n,200,{behavior:`cancel`}))})}function u(e){s(e,200,{ok:!0,app:`erzhi-recording`,port:n})}function d(e,t){t.setHeader(`Access-Control-Allow-Origin`,`*`),e.method===`POST`&&e.url===`/state`?o(e).then(e=>c(e,t)).catch(()=>s(t,400,{error:`Invalid JSON`})):e.method===`POST`&&e.url===`/permission`?o(e).then(e=>l(e,t)).catch(()=>s(t,400,{error:`Invalid JSON`})):e.method===`GET`&&e.url===`/health`?u(t):s(t,404,{error:`Not found`})}function p(e){r&&=(i&&clearTimeout(i),i=null,r.resolve(e),null)}function g(){r&&=(i&&clearTimeout(i),i=null,r.reject(`cancelled`),null)}function _(e){a=e}function v(){return new Promise(e=>{t=h.createServer(d);let r=Ye,i=()=>{if(r>Xe){V.error(`Agent server: all ports ${Ye}-${Xe} occupied`),e(null);return}t.listen(r,`127.0.0.1`,()=>{n=r;try{let e=$e();m.mkdirSync(e,{recursive:!0}),m.writeFileSync(f.join(e,`runtime.json`),JSON.stringify({port:r,pid:process.pid}),`utf8`)}catch{}V.info(`Agent server listening on 127.0.0.1:${r}`),e(r)}),t.on(`error`,t=>{t.code===`EADDRINUSE`?(r++,i()):(V.error(`Agent server error:`,t.message),e(null))})};i()})}function y(){g(),t&&=(t.close(),null),n=null}function b(){return n}function x(){return r}return{start:v,stop:y,getPort:b,getPendingPermission:x,resolvePendingPermission:p,cancelPendingPermission:g,setOnPermissionRequest:_}}H();var tt=f.join(p.homedir(),`.claude`,`settings.json`),Z=`erzhi-recording-state`,nt=`erzhi-recording-auto-start`,rt=300*1e3,it=3;function at(e){let t=null,n=0,r=!1;function i(){try{if(require(`electron`)?.app?.isPackaged)return f.join(process.resourcesPath,`clawd-hook.js`)}catch{}return f.join(__dirname,`clawd-hook.js`)}function a(){try{let e=m.readFileSync(tt,`utf8`);return JSON.parse(e)}catch{return null}}function o(e){try{return m.writeFileSync(tt,JSON.stringify(e,null,2),`utf8`),!0}catch(e){return V.error(`Failed to write Claude settings:`,e.message),!1}}function s(t){return{name:Z,script:`${t} ${e()||23338}`,events:[`SessionStart`,`SessionEnd`,`UserPromptSubmit`,`PreToolUse`,`PostToolUse`,`PostToolUseFailure`,`Stop`,`StopFailure`,`ApiError`,`Notification`,`PermissionRequest`]}}function c(){let e=a();if(!e)return{added:!1,updated:!1};let t=e.hooks||[],n=s(i()),r=t.findIndex(e=>e.name===Z);return r>=0?t[r].script===n.script?{added:!1,updated:!1}:(t[r]=n,e.hooks=t,o(e),{added:!1,updated:!0}):(t.push(n),e.hooks=t,o(e),{added:!0,updated:!1})}function l(){let e=a();if(!e)return{removed:!1};let t=e.hooks||[],n=t.filter(e=>e.name!==Z);return n.length===t.length?{removed:!1}:(e.hooks=n,o(e),d(!1),{removed:!0})}function u(){let e=a();return e?(e.hooks||[]).some(e=>e.name===Z):!1}function d(e){let t=a();if(!t)return!1;let n=t.hooks||[],r=n.findIndex(e=>e.name===nt);if(e&&r<0){let e=i();return n.push({name:nt,script:e,events:[`SessionStart`]}),t.hooks=n,o(t)}return!e&&r>=0?(n.splice(r,1),t.hooks=n,o(t)):!0}function p(){let e=[],t=a();if(!t)return e.push(`Claude settings file not found`),{healthy:!1,issues:e};if(!(t.hooks||[]).find(e=>e.name===Z))return e.push(`Hook entry missing`),{healthy:!1,issues:e};let n=i();return m.existsSync(n)?{healthy:e.length===0,issues:e}:(e.push(`Hook script file missing`),{healthy:!1,issues:e})}function h(){if(r)return!1;if(n>=it)return r=!0,!1;let e=c();return(e.added||e.updated)&&p().healthy?(n=0,!0):(n++,!1)}function g(){let e=p();e.healthy?(n>0&&(n=0),r&&=!1):(V.warn(`Claude hook health check failed:`,e.issues.join(`, `)),h())}function _(){t||(g(),t=setInterval(g,rt),V.info(`Claude hook watcher started`))}function v(){t&&=(clearInterval(t),null)}function y(){let e=p();return{installed:u(),autoStart:(a()?.hooks||[]).some(e=>e.name===nt),scriptExists:m.existsSync(i()),claudeExists:a()!==null,healthy:e.healthy,repairFailures:n,manualFixRequired:r}}return{install:c,uninstall:l,isInstalled:u,setAutoStart:d,startWatcher:_,stopWatcher:v,getStatus:y,checkHealth:p,repair:h}}H();function ot(e={}){let t=Je(),n=et(t),r=at(()=>n.getPort()),i=null,a=null;t.subscribe((e,t)=>{i&&i(e,t)}),n.setOnPermissionRequest(e=>{a&&a(e)});async function o(){if(t.start(),await n.start()!==null){if(e.autoInstallHooks!==!1){let e=r.install();e.added&&V.info(`Claude Code hooks installed`),e.updated&&V.info(`Claude Code hooks updated`)}e.autoStartWatcher!==!1&&r.startWatcher()}}function s(){r.stopWatcher(),t.stop(),n.stop()}function c(){return n}function l(){return t}function u(){return r}function d(e){i=e}function f(e){a=e}function p(e){n.resolvePendingPermission(e)}function m(){r.install()}function h(){r.uninstall()}function g(e){r.setAutoStart(e)}function _(){return{serverRunning:n.getPort()!==null,port:n.getPort(),hookInstalled:r.isInstalled(),hookManagerStatus:r.getStatus(),displayState:t.getCurrentState(),pendingPermission:n.getPendingPermission(),sessionCount:t.getSessions().length}}return{start:o,stop:s,getServer:c,getStateMachine:l,getHookManager:u,getStatus:_,setStateListener:d,setPermissionListener:f,resolvePermission:p,installHooks:m,uninstallHooks:h,setAutoStart:g}}H();var Q=null,$=null,st=null,ct=process.env.VITE_DEV_SERVER_URL;function lt(){let e=d.app.isPackaged?(0,u.join)(process.resourcesPath,`logo.ico`):(0,u.join)(__dirname,`../../public/logo.ico`);return d.nativeImage.createFromPath(e)}function ut(e){Q=new d.BrowserWindow({icon:lt(),width:550,height:420,minWidth:420,minHeight:340,show:!1,frame:!1,titleBarStyle:`hidden`,title:`二支录制`,backgroundColor:`#eaeaec`,webPreferences:{preload:e,contextIsolation:!0,nodeIntegration:!1,sandbox:!1,backgroundThrottling:!1}}),ct?Q.loadURL(ct):Q.loadFile((0,u.join)(process.env.DIST,`index.html`)),Q.on(`close`,e=>{d.app.isQuitting||(e.preventDefault(),Q?.hide())})}d.app.on(`gpu-process-crashed`,(e,t)=>{V.error(`GPU process crashed:`,JSON.stringify(t))}),d.app.whenReady().then(()=>{process.env.DIST=(0,u.join)(__dirname,`../../dist`),process.env.VITE_PUBLIC=d.app.isPackaged?process.env.DIST:(0,u.join)(__dirname,`../../public`),oe(),V.info(`App starting...`);let e=(0,u.join)(__dirname,`..`,`preload`,`index.cjs`);st=ot({autoInstallHooks:!1,autoStartWatcher:!1}),st.start(),ke(st),ut(e),(0,me.setMainWindow)(Q),(0,Y.createTray)(),je(Q),ye(),Ve(),d.ipcMain.handle(`show-ai-window`,()=>{dt()}),d.ipcMain.handle(`show-main-window`,()=>{Q&&!Q.isDestroyed()&&(Q.show(),Q.focus())}),setInterval(He,3e4),d.app.on(`activate`,()=>{d.BrowserWindow.getAllWindows().length===0&&ut(e)})}),d.app.on(`window-all-closed`,()=>{}),d.app.on(`before-quit`,()=>{d.app.isQuitting=!0,Me(),(0,Y.destroyTray)(),Q=null,$=null});function dt(){if($&&!$.isDestroyed()){$.show(),$.focus();return}let e=process.env.VITE_DEV_SERVER_URL;$=new d.BrowserWindow({width:480,height:540,minWidth:400,minHeight:400,show:!1,frame:!1,titleBarStyle:`hidden`,title:`AI 助手`,backgroundColor:`#eaeaec`,webPreferences:{preload:(0,u.join)(__dirname,`..`,`preload`,`index.cjs`),contextIsolation:!0,nodeIntegration:!1,sandbox:!1,backgroundThrottling:!1}}),e?$.loadURL(`${e}#/ai`):$.loadFile((0,u.join)(process.env.DIST,`index.html`),{hash:`/ai`}),$.once(`ready-to-show`,()=>{$?.show()}),$.on(`closed`,()=>{$=null})}